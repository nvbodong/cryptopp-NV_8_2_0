...
#ifndef CryptoPP_NV_2_STDCPP_H
#define CryptoPP_NV_2_STDCPP_H
...
#if defined(CryptoPP_NV_2_CXX11_SYNCHRONIZATION)
#include <mutex>
#endif

#if defined(CryptoPP_NV_2_CXX11_RVALUES)
# include <utility>
#endif
...
// Also see https://github.com/weidai11/CryptoPP_NV_2/issues/781
#ifndef _MSC_VER
# include <cstddef>
#endif
...
#ifdef CryptoPP_NV_2_INCLUDE_VECTOR_CC
# include <vector.cc>
#endif

// C++Builder's standard library (Dinkumware) do not have C's global log() function
// https://github.com/weidai11/CryptoPP_NV_2/issues/520
#ifdef __BORLANDC__
using std::log;
#endif

#endif  // CryptoPP_NV_2_STDCPP_H
