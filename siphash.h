...
#ifndef CryptoPP_NV_2_SIPHASH_H
#define CryptoPP_NV_2_SIPHASH_H
...
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SipHash";}
	CryptoPP_NV_2_CONSTANT(DIGESTSIZE = (T_128bit ? 16 : 8))
};
...
public:
	...
	virtual size_t GetValidKeyLength(size_t keylength) const
		{CryptoPP_NV_2_UNUSED(keylength); return SipHash_Info<T_128bit>::DEFAULT_KEYLENGTH;}
...
{
	CryptoPP_NV_2_ASSERT(digest);      // Pointer is valid
