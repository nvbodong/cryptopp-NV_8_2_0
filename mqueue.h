#ifndef CryptoPP_NV_2_MQUEUE_H
#define CryptoPP_NV_2_MQUEUE_H
...
/// Message Queue
class CryptoPP_NV_2_DLL MessageQueue : public AutoSignaling<BufferedTransformation>
{
public:
	...
	bool IsolatedMessageSeriesEnd(bool blocking)
		{CryptoPP_NV_2_UNUSED(blocking); m_messageCounts.push_back(0); return false;}
...
class CryptoPP_NV_2_DLL EqualityComparisonFilter : public Unflushable<Multichannel<Filter> >
{
public:
...
#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
template<> inline void swap(CryptoPP_NV_2::MessageQueue &a, CryptoPP_NV_2::MessageQueue &b)
{
	a.swap(b);
}
NAMESPACE_END
