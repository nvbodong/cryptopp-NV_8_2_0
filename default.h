...
#ifndef CryptoPP_NV_2_DEFAULT_H
#define CryptoPP_NV_2_DEFAULT_H
...
{
	CryptoPP_NV_2_CONSTANT(BLOCKSIZE  = BlockSize)
	CryptoPP_NV_2_CONSTANT(KEYLENGTH  = KeyLength)
	CryptoPP_NV_2_CONSTANT(SALTLENGTH = SaltSize)
	CryptoPP_NV_2_CONSTANT(DIGESTSIZE = DigestSize)
	CryptoPP_NV_2_CONSTANT(ITERATIONS = Iterations)
};
...
{
public:
	CryptoPP_NV_2_CONSTANT(BLOCKSIZE  = Info::BLOCKSIZE)
	CryptoPP_NV_2_CONSTANT(KEYLENGTH  = Info::KEYLENGTH)
	CryptoPP_NV_2_CONSTANT(SALTLENGTH = Info::SALTLENGTH)
	CryptoPP_NV_2_CONSTANT(DIGESTSIZE = Info::DIGESTSIZE)
	CryptoPP_NV_2_CONSTANT(ITERATIONS = Info::ITERATIONS)
...
protected:
	void FirstPut(const byte *inString) {CryptoPP_NV_2_UNUSED(inString);}
	void LastPut(const byte *inString, size_t length);
