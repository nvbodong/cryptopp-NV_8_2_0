...
///   <A HREF="https://www.CryptoPP_NV_2.com/wiki/HC-128">Crypto++ Wiki | HC-128</A>.
/// \since Crypto++ 8.0

#ifndef CryptoPP_NV_2_HC128_H
#define CryptoPP_NV_2_HC128_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "HC-128"; }
};
