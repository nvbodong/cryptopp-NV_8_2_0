...
using CryptoPP_NV_2::ECP;
using CryptoPP_NV_2::ModularArithmetic;

#if defined(HAVE_GCC_INIT_PRIORITY)
  const ECP::Point g_identity __attribute__ ((init_priority (CryptoPP_NV_2_INIT_PRIORITY + 51))) = ECP::Point();
...
void ECP::SimultaneousMultiply(ECP::Point *results, const ECP::Point &P, const Integer *expBegin, unsigned int expCount) const
{
	...
	{
		CryptoPP_NV_2_ASSERT(expBegin->NotNegative());
