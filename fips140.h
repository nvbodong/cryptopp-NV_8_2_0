...
/// \sa <A HREF="http://CryptoPP_NV_2.com/wiki/Visual_Studio">Visual Studio</A> and
///   <A HREF="http://CryptoPP_NV_2.com/wiki/config.h">config.h</A> on the Crypto++ wiki.

#ifndef CryptoPP_NV_2_FIPS140_H
#define CryptoPP_NV_2_FIPS140_H
...
///   when CryptoPP_NV_2_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined.
class CryptoPP_NV_2_DLL SelfTestFailure : public Exception
{
public:
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API FIPS_140_2_ComplianceEnabled();
...
///   when CryptoPP_NV_2_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined.
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API DoPowerUpSelfTest(const char *moduleFilename, const byte *expectedModuleMac);
...
/// \details The self tests for an algorithm are performed by the Algortihm class
///   when CryptoPP_NV_2_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined.
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API DoDllPowerUpSelfTest();
...
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API SimulatePowerUpSelfTestFailure();

/// \brief Provides the current power-up self test status
/// \returns the current power-up self test status
CryptoPP_NV_2_DLL PowerUpSelfTestStatus CryptoPP_NV_2_API GetPowerUpSelfTestStatus();

#ifndef CryptoPP_NV_2_DOXYGEN_PROCESSING
typedef PowerUpSelfTestStatus (CryptoPP_NV_2_API * PGetPowerUpSelfTestStatus)();
#endif

/// \brief Class object that calculates the MAC on the module
/// \returns the MAC for the module
CryptoPP_NV_2_DLL MessageAuthenticationCode * CryptoPP_NV_2_API NewIntegrityCheckingMAC();
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IntegrityCheckModule(const char *moduleFilename, const byte *expectedModuleMac, SecByteBlock *pActualMac = NULLPTR, unsigned long *pMacFileLocation = NULLPTR);
...
/// \details After the DLL is built but before it is MAC'd, the string CryptoPP_NV_2_DUMMY_DLL_MAC
...
#define CryptoPP_NV_2_DUMMY_DLL_MAC "MAC_51f34b8db820ae8"
