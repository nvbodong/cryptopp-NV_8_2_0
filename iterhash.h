...
#ifndef CryptoPP_NV_2_ITERHASH_H
#define CryptoPP_NV_2_ITERHASH_H
...
class CryptoPP_NV_2_DLL HashInputTooLong : public InvalidDataFormat
{
public:
...
class CryptoPP_NV_2_NO_VTABLE IteratedHashBase : public BASE
{
public:
...
class CryptoPP_NV_2_NO_VTABLE IteratedHash : public IteratedHashBase<T_HashWordType, T_Base>
{
public:
	typedef T_Endianness ByteOrderClass;
	typedef T_HashWordType HashWordType;

	CryptoPP_NV_2_CONSTANT(BLOCKSIZE = T_BlockSize)
	// BCB2006 workaround: can't use BLOCKSIZE here
	CryptoPP_NV_2_COMPILE_ASSERT((T_BlockSize & (T_BlockSize - 1)) == 0);	// blockSize is a power of 2
	...
	{
		CryptoPP_NV_2_ASSERT(in != NULLPTR);
		CryptoPP_NV_2_ASSERT(out != NULLPTR);
		CryptoPP_NV_2_ASSERT(IsAligned<T_HashWordType>(in));
		CryptoPP_NV_2_ASSERT(IsAligned<T_HashWordType>(out));
...
class CryptoPP_NV_2_NO_VTABLE IteratedHashWithStaticTransform
	: public ClonableImpl<T_Transform, AlgorithmImpl<IteratedHash<T_HashWordType, T_Endianness, T_BlockSize>, T_Transform> >
{
public:
	CryptoPP_NV_2_CONSTANT(DIGESTSIZE = T_DigestSize ? T_DigestSize : T_StateSize)
...
protected:
	...
	CryptoPP_NV_2_DLL_TEMPLATE_CLASS IteratedHashBase<word64, HashTransformation>;
	CryptoPP_NV_2_STATIC_TEMPLATE_CLASS IteratedHashBase<word64, MessageAuthenticationCode>;

	CryptoPP_NV_2_DLL_TEMPLATE_CLASS IteratedHashBase<word32, HashTransformation>;
	CryptoPP_NV_2_STATIC_TEMPLATE_CLASS IteratedHashBase<word32, MessageAuthenticationCode>;
#endif
