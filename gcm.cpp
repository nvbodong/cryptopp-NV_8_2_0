...
// use "cl /EP /P /DCryptoPP_NV_2_GENERATE_X64_MASM gcm.cpp" to generate MASM code
...
#if defined(CryptoPP_NV_2_DISABLE_GCM_ASM)
...
#if defined(CryptoPP_NV_2_DISABLE_MIXED_ASM)
...
{
    CryptoPP_NV_2_ASSERT(IsAlignedOn(a,GetAlignmentOf<word64>()));
    CryptoPP_NV_2_ASSERT(IsAlignedOn(b,GetAlignmentOf<word64>()));
    CryptoPP_NV_2_ASSERT(IsAlignedOn(c,GetAlignmentOf<word64>()));
    ((word64 *)(void *)a)[0] = ((word64 *)(void *)b)[0] ^ ((word64 *)(void *)c)[0];
    ((word64 *)(void *)a)[1] = ((word64 *)(void *)b)[1] ^ ((word64 *)(void *)c)[1];
}

#if CryptoPP_NV_2_SSE2_INTRIN_AVAILABLE || CryptoPP_NV_2_SSE2_ASM_AVAILABLE
...
#if CryptoPP_NV_2_CLMUL_AVAILABLE
...
#endif  // CryptoPP_NV_2_CLMUL_AVAILABLE

#if CryptoPP_NV_2_ARM_PMULL_AVAILABLE
...
#endif  // CryptoPP_NV_2_ARM_PMULL_AVAILABLE

#if CryptoPP_NV_2_POWER8_VMULL_AVAILABLE
...
#endif  // CryptoPP_NV_2_POWER8_VMULL_AVAILABLE
...
void GCM_Base::SetKeyWithoutResync(const byte *userKey, size_t keylength, const NameValuePairs &params)
{
    ...
    // https://github.com/weidai11/CryptoPP_NV_2/issues/408.
    const unsigned int blockSize = blockCipher.BlockSize();
    CryptoPP_NV_2_ASSERT(blockSize == REQUIRED_BLOCKSIZE);
    ...
    if (HasCLMUL())
    {
        ...
        CryptoPP_NV_2_ASSERT(tableSize > static_cast<int>(blockSize));
    }
    else
#elif CryptoPP_NV_2_ARM_PMULL_AVAILABLE
    if (HasPMULL())
    {
        // Avoid "parameter not used" error and suppress Coverity finding
        (void)params.GetIntValue(Name::TableSize(), tableSize);
...
#elif CryptoPP_NV_2_POWER8_VMULL_AVAILABLE
    if (HasPMULL())
    {
        // Avoid "parameter not used" error and suppress Coverity finding
        (void)params.GetIntValue(Name::TableSize(), tableSize);
...
#endif    // Not CryptoPP_NV_2_GENERATE_X64_MASM
...
size_t GCM_Base::AuthenticateBlocks(const byte *data, size_t len)
{
    ...
    CryptoPP_NV_2_ASSERT(IsAlignedOn(hashBuffer,GetAlignmentOf<word64>()));
    ...
    case 1:        // SSE2 and 2K tables
        {
            ...
            (
            INTEL_NOPREFIX
        #elif defined(CryptoPP_NV_2_GENERATE_X64_MASM)
            ALIGN   8
