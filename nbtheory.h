...
#ifndef CryptoPP_NV_2_NBTHEORY_H
#define CryptoPP_NV_2_NBTHEORY_H
...
CryptoPP_NV_2_DLL const word16 * CryptoPP_NV_2_API GetPrimeTable(unsigned int &size);
...
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API MaurerProvablePrime(RandomNumberGenerator &rng, unsigned int bits);
...
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API MihailescuProvablePrime(RandomNumberGenerator &rng, unsigned int bits);
...
///   in the table.
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IsSmallPrime(const Integer &p);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API TrialDivision(const Integer &p, unsigned bound);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API SmallDivisorsTest(const Integer &p);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IsFermatProbablePrime(const Integer &n, const Integer &b);
...
///   IsStrongLucasProbablePrime instead.
/// \sa IsStrongProbablePrime, IsStrongLucasProbablePrime
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IsLucasProbablePrime(const Integer &n);

/// \brief Determine if a number is probably prime
/// \param n the number to test
/// \param b the base to exponentiate
/// \returns true if the number n is probably prime, false otherwise.
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IsStrongProbablePrime(const Integer &n, const Integer &b);

/// \brief Determine if a number is probably prime
/// \param n the number to test
/// \returns true if the number n is probably prime, false otherwise.
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IsStrongLucasProbablePrime(const Integer &n);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API RabinMillerTest(RandomNumberGenerator &rng, const Integer &n, unsigned int rounds);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API IsPrime(const Integer &p);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API VerifyPrime(RandomNumberGenerator &rng, const Integer &p, unsigned int level = 1);

/// \brief Application callback to signal suitability of a cabdidate prime
class CryptoPP_NV_2_DLL PrimeSelector
{
public:
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API FirstPrime(Integer &p, const Integer &max, const Integer &equiv, const Integer &mod, const PrimeSelector *pSelector);

CryptoPP_NV_2_DLL unsigned int CryptoPP_NV_2_API PrimeSearchInterval(const Integer &max);

CryptoPP_NV_2_DLL AlgorithmParameters CryptoPP_NV_2_API MakeParametersForTwoPrimesOfEqualSize(unsigned int productBitLength);
...
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API CRT(const Integer &xp, const Integer &p, const Integer &xq, const Integer &q, const Integer &u);
...
CryptoPP_NV_2_DLL int CryptoPP_NV_2_API Jacobi(const Integer &a, const Integer &b);

/// \brief Calculate the Lucas value
/// \returns the Lucas value
/// \details Lucas() calculates the Lucas function <tt>V_e(p, 1) mod n</tt>.
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API Lucas(const Integer &e, const Integer &p, const Integer &n);
...
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API InverseLucas(const Integer &e, const Integer &m, const Integer &p, const Integer &q, const Integer &u);
...
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API ModularSquareRoot(const Integer &a, const Integer &p);
...
CryptoPP_NV_2_DLL Integer CryptoPP_NV_2_API ModularRoot(const Integer &a, const Integer &dp, const Integer &dq, const Integer &p, const Integer &q, const Integer &u);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API SolveModularQuadraticEquation(Integer &r1, Integer &r2, const Integer &a, const Integer &b, const Integer &c, const Integer &p);
...
CryptoPP_NV_2_DLL unsigned int CryptoPP_NV_2_API DiscreteLogWorkFactor(unsigned int bitlength);
...
///   calculate discrete log or factor a number.
CryptoPP_NV_2_DLL unsigned int CryptoPP_NV_2_API FactoringWorkFactor(unsigned int bitlength);

// ********************************************************

/// \brief Generator of prime numbers of special forms
class CryptoPP_NV_2_DLL PrimeAndGenerator
{
public:
