...
#ifndef CryptoPP_NV_2_SEED_H
#define CryptoPP_NV_2_SEED_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SEED";}
};
...
{
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SEED_Info>
	{
	public:
