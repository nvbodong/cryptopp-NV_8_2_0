...
#ifndef CryptoPP_NV_2_ARC4_H
#define CryptoPP_NV_2_ARC4_H
...
/// \since Crypto++ 3.1
class CryptoPP_NV_2_NO_VTABLE ARC4_Base : public VariableKeyLength<16, 1, 256>, public RandomNumberGenerator, public SymmetricCipher, public SymmetricCipherDocumentation
{
public:
	~ARC4_Base();

	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ARC4";}
...
/// \brief Alleged RC4
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/RC4">Alleged RC4</a>
/// \since Crypto++ 3.1
...
/// \since Crypto++ 3.1
class CryptoPP_NV_2_NO_VTABLE MARC4_Base : public ARC4_Base
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "MARC4";}
