...
#ifndef CryptoPP_NV_2_ECCRYPTO_H
#define CryptoPP_NV_2_ECCRYPTO_H
...
public:
	...
	static std::string CryptoPP_NV_2_API StaticAlgorithmNamePrefix() {return "EC";}
	...
	static OID CryptoPP_NV_2_API GetNextRecommendedParametersOID(const OID &oid);
...
{
public:
  CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "ECDSA";}
};
...
{
public:
  CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "ECDSA-RFC6979";}
};
...
{
public:
  CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "ECNR";}
};
...
struct ECDSA_RFC6979 : public DL_SS<
	...
	ECDSA_RFC6979<EC,H> >
{
	static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return std::string("ECDSA-RFC6979/") + H::StaticAlgorithmName();}
};
...
public:
	...
	void Initialize(const DL_GroupParameters_EC<EC> &params, const Integer &x)
	{
		...
		CryptoPP_NV_2_ASSERT(x>=1 && x<=params.GetSubgroupOrder()-1);
	}
	...
	void Initialize(const EC &ec, const Element &G, const Integer &n, const Integer &x)
	{
		...
		this->SetPrivateExponent(x);
		CryptoPP_NV_2_ASSERT(x>=1 && x<=this->AccessGroupParameters().GetSubgroupOrder()-1);
	}
	...
	virtual void MakePublicKey(DL_PublicKey_ECGDSA<EC> &pub) const
	{
		...
		CryptoPP_NV_2_ASSERT(xInv.NotZero());
	}
...
{
public:
  CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "ECGDSA";}
};
...
struct ECGDSA : public DL_SS<
	...
	H>
{
	static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return std::string("ECGDSA-ISO15946/") + H::StaticAlgorithmName();}
};
		...
		ECIES<EC> >
{
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "ECIES";}
};

NAMESPACE_END

#ifdef CryptoPP_NV_2_MANUALLY_INSTANTIATE_TEMPLATES
#include "eccrypto.cpp"
#endif

NAMESPACE_BEGIN(CryptoPP_NV_2)

CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_GroupParameters_EC<ECP>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_GroupParameters_EC<EC2N>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKeyImpl<DL_GroupParameters_EC<ECP> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKeyImpl<DL_GroupParameters_EC<EC2N> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKey_EC<ECP>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKey_EC<EC2N>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKey_ECGDSA<ECP>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKey_ECGDSA<EC2N>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKeyImpl<DL_GroupParameters_EC<ECP> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKeyImpl<DL_GroupParameters_EC<EC2N> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_EC<ECP>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_EC<EC2N>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_ECGDSA<ECP>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_ECGDSA<EC2N>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<ECP::Point>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<EC2N::Point>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_EC<ECP>, ECDSA<ECP, SHA256> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_EC<EC2N>, ECDSA<EC2N, SHA256> >;
