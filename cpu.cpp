...
// CryptoPP_NV_2_GLIBC_VERSION not used because config.h is missing <feature.h>
#if (((__GLIBC__ * 100) + __GLIBC_MINOR__) >= 216)
# define CryptoPP_NV_2_GETAUXV_AVAILABLE 1
#endif

#if CryptoPP_NV_2_GETAUXV_AVAILABLE
# include <sys/auxv.h>
#else
#ifndef AT_HWCAP
# define AT_HWCAP 16
...
#ifndef CryptoPP_NV_2_MS_STYLE_INLINE_ASSEMBLY
extern "C" {
...
extern "C"
{
	...
	{
		CryptoPP_NV_2_UNUSED(unused);
		longjmp(s_jmpNoCPUID, 1);
	}
}
#endif  // Not CryptoPP_NV_2_MS_STYLE_INLINE_ASSEMBLY
...
#elif _MSC_VER >= 1400 && CryptoPP_NV_2_BOOL_X64
...
{
#if defined(CryptoPP_NV_2_MS_STYLE_INLINE_ASSEMBLY) || defined(__BORLANDC__)
    __try
	{
	...
	// http://github.com/weidai11/CryptoPP_NV_2/issues/24 and http://stackoverflow.com/q/7721854
...
# if CryptoPP_NV_2_BOOL_X32 || CryptoPP_NV_2_BOOL_X64
...
bool CryptoPP_NV_2_SECTION_INIT g_x86DetectionDone = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSSE2 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSSSE3 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSSE41 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSSE42 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasAVX = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasAVX2 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasAESNI = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasCLMUL = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasADX = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasRDRAND = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasRDSEED = false;
bool CryptoPP_NV_2_SECTION_INIT g_isP4 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPadlockRNG = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPadlockACE = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPadlockACE2 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPadlockPHE = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPadlockPMM = false;
word32 CryptoPP_NV_2_SECTION_INIT g_cacheLineSize = CryptoPP_NV_2_L1_CACHE_LINE_SIZE;
...
void DetectX86Features()
{
	...
	// See http://github.com/weidai11/CryptoPP_NV_2/issues/511 and http://stackoverflow.com/a/22521619/608639
	if ((cpuid1[3] & (1 << 26)) != 0)
	...
	CryptoPP_NV_2_CONSTANT(YMM_FLAG = (3 <<  1))
	CryptoPP_NV_2_CONSTANT(AVX_FLAG = (3 << 27))
...
// _xgetbv is available
	...
	if (IsIntel(cpuid0))
	{
		CryptoPP_NV_2_CONSTANT(RDRAND_FLAG = (1 << 30))
		CryptoPP_NV_2_CONSTANT(RDSEED_FLAG = (1 << 18))
		CryptoPP_NV_2_CONSTANT(   ADX_FLAG = (1 << 19))
		CryptoPP_NV_2_CONSTANT(   SHA_FLAG = (1 << 29))
		CryptoPP_NV_2_CONSTANT(  AVX2_FLAG = (1 <<  5))
	...
	{
		CryptoPP_NV_2_CONSTANT( RNG_FLAGS = (0x3 << 2))
		CryptoPP_NV_2_CONSTANT( ACE_FLAGS = (0x3 << 6))
		CryptoPP_NV_2_CONSTANT(ACE2_FLAGS = (0x3 << 8))
		CryptoPP_NV_2_CONSTANT( PHE_FLAGS = (0x3 << 10))
		CryptoPP_NV_2_CONSTANT( PMM_FLAGS = (0x3 << 12))
	...
	if (g_cacheLineSize == 0)
		g_cacheLineSize = CryptoPP_NV_2_L1_CACHE_LINE_SIZE;
...
#elif (CryptoPP_NV_2_BOOL_ARM32 || CryptoPP_NV_2_BOOL_ARMV8)

bool CryptoPP_NV_2_SECTION_INIT g_ArmDetectionDone = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasARMv7 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasNEON = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPMULL = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasCRC32 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasAES = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA1 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA2 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA512 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA3 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSM3 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSM4 = false;
word32 CryptoPP_NV_2_SECTION_INIT g_cacheLineSize = CryptoPP_NV_2_L1_CACHE_LINE_SIZE;
...
#elif (CryptoPP_NV_2_BOOL_PPC32 || CryptoPP_NV_2_BOOL_PPC64)

bool CryptoPP_NV_2_SECTION_INIT g_PowerpcDetectionDone = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasAltivec = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPower7 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPower8 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPower9 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasAES = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasPMULL = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA256 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasSHA512 = false;
bool CryptoPP_NV_2_SECTION_INIT g_hasDARN = false;
word32 CryptoPP_NV_2_SECTION_INIT g_cacheLineSize = CryptoPP_NV_2_L1_CACHE_LINE_SIZE;
...
public:
	...
	{
#if CryptoPP_NV_2_BOOL_X86 || CryptoPP_NV_2_BOOL_X32 || CryptoPP_NV_2_BOOL_X64
		CryptoPP_NV_2::DetectX86Features();
#elif CryptoPP_NV_2_BOOL_ARM32 || CryptoPP_NV_2_BOOL_ARMV8
		CryptoPP_NV_2::DetectArmFeatures();
#elif CryptoPP_NV_2_BOOL_PPC32 || CryptoPP_NV_2_BOOL_PPC64
		CryptoPP_NV_2::DetectPowerpcFeatures();
#endif
	}
};
...
// Dynamic initialization will be used if init priorities are not available.
	...
	const InitCpu s_init __attribute__ ((init_priority (CryptoPP_NV_2_INIT_PRIORITY + 10))) = InitCpu();
