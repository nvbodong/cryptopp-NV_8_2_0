...
{
	CryptoPP_NV_2_ASSERT(outString); CryptoPP_NV_2_ASSERT(inString);
	CryptoPP_NV_2_ASSERT(length % this->MandatoryBlockSize() == 0);
	...
	//
	//       Also see https://github.com/weidai11/CryptoPP_NV_2/issues/683.
	//
