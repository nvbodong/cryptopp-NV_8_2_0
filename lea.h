...
#ifndef CryptoPP_NV_2_LEA_H
#define CryptoPP_NV_2_LEA_H
...
#if (CryptoPP_NV_2_BOOL_X64 || CryptoPP_NV_2_BOOL_X32 || CryptoPP_NV_2_BOOL_X86 || CryptoPP_NV_2_BOOL_ARM32 || CryptoPP_NV_2_BOOL_ARMV8)
# ifndef CryptoPP_NV_2_DISABLE_LEA_SIMD
#  define CryptoPP_NV_2_LEA_ADVANCED_PROCESS_BLOCKS 1
# endif
#endif
...
# undef CryptoPP_NV_2_LEA_ADVANCED_PROCESS_BLOCKS
#endif
...
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/LEA">LEA</a>,
...
/// \since Crypto++ 8.0
class CryptoPP_NV_2_NO_VTABLE LEA : public LEA_Info, public BlockCipherDocumentation
{
public:
    /// \brief LEA block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<LEA_Info>
    {
    protected:
...
#if CryptoPP_NV_2_LEA_ADVANCED_PROCESS_BLOCKS
