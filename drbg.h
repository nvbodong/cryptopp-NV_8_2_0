...
#ifndef CryptoPP_NV_2_NIST_DRBG_H
#define CryptoPP_NV_2_NIST_DRBG_H
...
{
public:
    CryptoPP_NV_2_CONSTANT(SECURITY_STRENGTH=STRENGTH)
    CryptoPP_NV_2_CONSTANT(SEED_LENGTH=SEEDLENGTH)
    CryptoPP_NV_2_CONSTANT(MINIMUM_ENTROPY=STRENGTH)
    CryptoPP_NV_2_CONSTANT(MINIMUM_NONCE=0)
    CryptoPP_NV_2_CONSTANT(MINIMUM_ADDITIONAL=0)
    CryptoPP_NV_2_CONSTANT(MINIMUM_PERSONALIZATION=0)
    CryptoPP_NV_2_CONSTANT(MAXIMUM_ENTROPY=INT_MAX)
    CryptoPP_NV_2_CONSTANT(MAXIMUM_NONCE=INT_MAX)
    CryptoPP_NV_2_CONSTANT(MAXIMUM_ADDITIONAL=INT_MAX)
    CryptoPP_NV_2_CONSTANT(MAXIMUM_PERSONALIZATION=INT_MAX)
    CryptoPP_NV_2_CONSTANT(MAXIMUM_BYTES_PER_REQUEST=65536)
    CryptoPP_NV_2_CONSTANT(MAXIMUM_REQUESTS_BEFORE_RESEED=INT_MAX)
    ...
    const byte* personalization, size_t personalizationLength)
{
    ...
    CryptoPP_NV_2_ASSERT(entropyLength >= MINIMUM_ENTROPY);
    ...
    CryptoPP_NV_2_ASSERT(entropyLength <= MAXIMUM_ENTROPY);
    CryptoPP_NV_2_ASSERT(nonceLength <= MAXIMUM_NONCE);
    CryptoPP_NV_2_ASSERT(personalizationLength <= MAXIMUM_PERSONALIZATION);
...
void Hash_DRBG<HASH, STRENGTH, SEEDLENGTH>::DRBG_Reseed(const byte* entropy, size_t entropyLength, const byte* additional, size_t additionaLength)
{
    ...
    // or too large a persoanlization string. We warn in Debug builds, but do nothing in Release builds.
    CryptoPP_NV_2_ASSERT(entropyLength <= MAXIMUM_ENTROPY);
    CryptoPP_NV_2_ASSERT(additionaLength <= MAXIMUM_ADDITIONAL);
...
void Hash_DRBG<HASH, STRENGTH, SEEDLENGTH>::Hash_Generate(const byte* additional, size_t additionaLength, byte *output, size_t size)
{
    ...
    if (additional && additionaLength)
    {
        ...
        CryptoPP_NV_2_ASSERT(SEEDLENGTH >= HASH::DIGESTSIZE);
    ...
    // Steps 4-7
    {
        ...
        CryptoPP_NV_2_ASSERT(SEEDLENGTH >= HASH::DIGESTSIZE);
        CryptoPP_NV_2_ASSERT(HASH::DIGESTSIZE >= sizeof(m_reseed));
...
#endif  // CryptoPP_NV_2_NIST_DRBG_H
