...
#ifndef CryptoPP_NV_2_POLY1305_H
#define CryptoPP_NV_2_POLY1305_H
...
/// \since Crypto++ 6.0
template <class T>
class CryptoPP_NV_2_NO_VTABLE Poly1305_Base : public FixedKeyLength<32, SimpleKeyingInterface::UNIQUE_IV, 16>, public MessageAuthenticationCode
{
	CryptoPP_NV_2_COMPILE_ASSERT(T::DEFAULT_KEYLENGTH == 16);
	CryptoPP_NV_2_COMPILE_ASSERT(T::BLOCKSIZE == 16);

public:
	static std::string StaticAlgorithmName() {return std::string("Poly1305(") + T::StaticAlgorithmName() + ")";}

	CryptoPP_NV_2_CONSTANT(DIGESTSIZE=T::BLOCKSIZE)
	CryptoPP_NV_2_CONSTANT(BLOCKSIZE=T::BLOCKSIZE)
...
{
public:
	CryptoPP_NV_2_CONSTANT(DEFAULT_KEYLENGTH=Poly1305_Base<T>::DEFAULT_KEYLENGTH)
...
public:
	...
	CryptoPP_NV_2_CONSTANT(DIGESTSIZE=16)
	CryptoPP_NV_2_CONSTANT(BLOCKSIZE=16)
...
#endif  // CryptoPP_NV_2_POLY1305_H
