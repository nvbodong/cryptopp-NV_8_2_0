...
#ifndef CryptoPP_NV_2_POLYNOMI_H
#define CryptoPP_NV_2_POLYNOMI_H
...
inline bool operator==(const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &a, const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &b)
...
///
template <class T, int instance>
inline CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> operator+(const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &a, const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &b)
	{return CryptoPP_NV_2::PolynomialOverFixedRing<T, instance>(a.Plus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> operator-(const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &a, const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &b)
	{return CryptoPP_NV_2::PolynomialOverFixedRing<T, instance>(a.Minus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> operator*(const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &a, const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &b)
	{return CryptoPP_NV_2::PolynomialOverFixedRing<T, instance>(a.Times(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> operator/(const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &a, const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &b)
	{return CryptoPP_NV_2::PolynomialOverFixedRing<T, instance>(a.DividedBy(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> operator%(const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &a, const CryptoPP_NV_2::PolynomialOverFixedRing<T, instance> &b)
	{return CryptoPP_NV_2::PolynomialOverFixedRing<T, instance>(a.Modulo(b, a.ms_fixedRing));}

NAMESPACE_END

NAMESPACE_BEGIN(std)
template<class T> inline void swap(CryptoPP_NV_2::PolynomialOver<T> &a, CryptoPP_NV_2::PolynomialOver<T> &b)
{
	a.swap(b);
}
template<class T, int i> inline void swap(CryptoPP_NV_2::PolynomialOverFixedRing<T,i> &a, CryptoPP_NV_2::PolynomialOverFixedRing<T,i> &b)
{
	a.swap(b);
}
NAMESPACE_END
