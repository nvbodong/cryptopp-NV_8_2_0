...
#ifndef CryptoPP_NV_2_BLAKE2_H
#define CryptoPP_NV_2_BLAKE2_H
...
struct BLAKE2s_Info : public VariableKeyLength<32,0,32,1,SimpleKeyingInterface::NOT_RESYNCHRONIZABLE>
{
    ...
    CryptoPP_NV_2_CONSTANT(MIN_KEYLENGTH = KeyBase::MIN_KEYLENGTH)
    CryptoPP_NV_2_CONSTANT(MAX_KEYLENGTH = KeyBase::MAX_KEYLENGTH)
    CryptoPP_NV_2_CONSTANT(DEFAULT_KEYLENGTH = KeyBase::DEFAULT_KEYLENGTH)

    CryptoPP_NV_2_CONSTANT(BLOCKSIZE = 64)
    CryptoPP_NV_2_CONSTANT(DIGESTSIZE = 32)
    CryptoPP_NV_2_CONSTANT(SALTSIZE = 8)
    CryptoPP_NV_2_CONSTANT(PERSONALIZATIONSIZE = 8)

    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "BLAKE2s";}
};
...
struct BLAKE2b_Info : public VariableKeyLength<64,0,64,1,SimpleKeyingInterface::NOT_RESYNCHRONIZABLE>
{
    ...
    CryptoPP_NV_2_CONSTANT(BLOCKSIZE = 128)
    CryptoPP_NV_2_CONSTANT(DIGESTSIZE = 64)
    CryptoPP_NV_2_CONSTANT(SALTSIZE = 16)
    CryptoPP_NV_2_CONSTANT(PERSONALIZATIONSIZE = 16)

    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "BLAKE2b";}
};

/// \brief BLAKE2s parameter block
struct CryptoPP_NV_2_NO_VTABLE BLAKE2s_ParameterBlock
{
    CryptoPP_NV_2_CONSTANT(SALTSIZE = BLAKE2s_Info::SALTSIZE)
    CryptoPP_NV_2_CONSTANT(DIGESTSIZE = BLAKE2s_Info::DIGESTSIZE)
    CryptoPP_NV_2_CONSTANT(PERSONALIZATIONSIZE = BLAKE2s_Info::PERSONALIZATIONSIZE)
...
struct CryptoPP_NV_2_NO_VTABLE BLAKE2b_ParameterBlock
{
    CryptoPP_NV_2_CONSTANT(SALTSIZE = BLAKE2b_Info::SALTSIZE)
    CryptoPP_NV_2_CONSTANT(DIGESTSIZE = BLAKE2b_Info::DIGESTSIZE)
    CryptoPP_NV_2_CONSTANT(PERSONALIZATIONSIZE = BLAKE2b_Info::PERSONALIZATIONSIZE)
...
/// \since Crypto++ 5.6.4
struct CryptoPP_NV_2_NO_VTABLE BLAKE2s_State
{
    BLAKE2s_State() {
        Reset();
    }
    ...
    CryptoPP_NV_2_CONSTANT(BLOCKSIZE = BLAKE2s_Info::BLOCKSIZE)
...
/// \since Crypto++ 5.6.4
struct CryptoPP_NV_2_NO_VTABLE BLAKE2b_State
{
    BLAKE2b_State() {
        Reset();
    }
    ...
    CryptoPP_NV_2_CONSTANT(BLOCKSIZE = BLAKE2b_Info::BLOCKSIZE)
...
{
public:
    CryptoPP_NV_2_CONSTANT(DEFAULT_KEYLENGTH = BLAKE2s_Info::DEFAULT_KEYLENGTH)
    CryptoPP_NV_2_CONSTANT(MIN_KEYLENGTH = BLAKE2s_Info::MIN_KEYLENGTH)
    CryptoPP_NV_2_CONSTANT(MAX_KEYLENGTH = BLAKE2s_Info::MAX_KEYLENGTH)
...
protected:
    ...
    void UncheckedSetKey(const byte* key, unsigned int length, const CryptoPP_NV_2::NameValuePairs& params);
...
{
public:
    CryptoPP_NV_2_CONSTANT(DEFAULT_KEYLENGTH = BLAKE2b_Info::DEFAULT_KEYLENGTH)
    CryptoPP_NV_2_CONSTANT(MIN_KEYLENGTH = BLAKE2b_Info::MIN_KEYLENGTH)
    CryptoPP_NV_2_CONSTANT(MAX_KEYLENGTH = BLAKE2b_Info::MAX_KEYLENGTH)
