...
#ifndef CryptoPP_NV_2_SAFER_H
#define CryptoPP_NV_2_SAFER_H
...
public:
	...
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipher
	{
	public:
...
class CryptoPP_NV_2_NO_VTABLE SAFER_Impl : public BlockCipherImpl<INFO, BASE>
{
protected:
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SAFER-K";}
};

/// \brief SAFER-K block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/SAFER-K">SAFER-K</a>
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SAFER-SK";}
};

/// \brief SAFER-SK block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/SAFER-SK">SAFER-SK</a>
