...
///   The Simon and Speck GitHub</A> and <A HREF="https://www.CryptoPP_NV_2.com/wiki/SPECK">
///   SPECK</A> on the Crypto++ wiki.
/// \since Crypto++ 6.0

#ifndef CryptoPP_NV_2_SPECK_H
#define CryptoPP_NV_2_SPECK_H
...
# ifndef CryptoPP_NV_2_DISABLE_SPECK_SIMD
#  define CryptoPP_NV_2_SPECK64_ADVANCED_PROCESS_BLOCKS 1
# endif
#endif
    ...
    CryptoPP_NV_2_BOOL_PPC32 || CryptoPP_NV_2_BOOL_PPC64
# ifndef CryptoPP_NV_2_DISABLE_SPECK_SIMD
#  define CryptoPP_NV_2_SPECK128_ADVANCED_PROCESS_BLOCKS 1
# endif
#endif
...
# undef CryptoPP_NV_2_SPECK64_ADVANCED_PROCESS_BLOCKS
# undef CryptoPP_NV_2_SPECK128_ADVANCED_PROCESS_BLOCKS
#endif
...
/// \sa SPECK64, SPECK128, <a href="http://www.CryptoPP_NV_2.com/wiki/SPECK">SPECK</a>
/// \since Crypto++ 6.0
template <class W>
struct SPECK_Base
{
...
///   The Simon and Speck GitHub</A>, <a href="http://www.CryptoPP_NV_2.com/wiki/SPECK">SPECK</a> on the
///   Crypto++ wiki
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE SPECK64 : public SPECK_Info<8, 12, 12, 16>, public BlockCipherDocumentation
{
public:
    /// \brief SPECK block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : protected SPECK_Base<word32>, public BlockCipherImpl<SPECK_Info<8, 12, 12, 16> >
    {
    public:
        /// \brief The algorithm name
        /// \returns the algorithm name
...
///   Crypto++ wiki
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE SPECK128 : public SPECK_Info<16, 16, 16, 32>, public BlockCipherDocumentation
{
public:
    /// \brief SPECK block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : protected SPECK_Base<word64>, public BlockCipherImpl<SPECK_Info<16, 16, 16, 32> >
    {
    public:
        /// \brief The algorithm name
        /// \returns the algorithm name
