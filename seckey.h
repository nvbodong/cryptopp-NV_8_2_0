...
#ifndef CryptoPP_NV_2_SECKEY_H
#define CryptoPP_NV_2_SECKEY_H
...
public:
	...
	CryptoPP_NV_2_CONSTANT(BLOCKSIZE = N)
};
...
public:
	...
	CryptoPP_NV_2_CONSTANT(ROUNDS = R)
};
...
public:
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR unsigned int StaticGetDefaultRounds(size_t keylength)
	{
		return CryptoPP_NV_2_UNUSED(keylength), static_cast<unsigned int>(DEFAULT_ROUNDS);
	}
...
public:
	...
	CryptoPP_NV_2_CONSTANT(KEYLENGTH=N)
	...
	CryptoPP_NV_2_CONSTANT(MIN_KEYLENGTH=N)
	...
	CryptoPP_NV_2_CONSTANT(IV_LENGTH = IV_L)
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR size_t CryptoPP_NV_2_API StaticGetValidKeyLength(size_t keylength)
	{
		return CryptoPP_NV_2_UNUSED(keylength), static_cast<size_t>(KEYLENGTH);
	}
};
...
class VariableKeyLength
{
	...
	CryptoPP_NV_2_COMPILE_ASSERT(Q > 0);
	CryptoPP_NV_2_COMPILE_ASSERT(N % Q == 0);
	CryptoPP_NV_2_COMPILE_ASSERT(M % Q == 0);
	CryptoPP_NV_2_COMPILE_ASSERT(N < M);
	CryptoPP_NV_2_COMPILE_ASSERT(D >= N);
	CryptoPP_NV_2_COMPILE_ASSERT(M >= D);
...
public:
	...
	/// \brief The maximum key length used by the algorithm provided as a constant
	/// \details MAX_KEYLENGTH is provided in bytes, not bits
	CryptoPP_NV_2_CONSTANT(MAX_KEYLENGTH=M)
	/// \brief The default key length used by the algorithm provided as a constant
	/// \details DEFAULT_KEYLENGTH is provided in bytes, not bits
	CryptoPP_NV_2_CONSTANT(DEFAULT_KEYLENGTH=D)
	/// \brief The key length multiple used by the algorithm provided as a constant
	/// \details MAX_KEYLENGTH is provided in bytes, not bits
	CryptoPP_NV_2_CONSTANT(KEYLENGTH_MULTIPLE=Q)
	/// \brief The default IV requirements for the algorithm provided as a constant
	/// \details The default value is NOT_RESYNCHRONIZABLE. See IV_Requirement
	///  in cryptlib.h for allowed values.
	CryptoPP_NV_2_CONSTANT(IV_REQUIREMENT=IV_REQ)
...
public:
	/// \brief The minimum key length used by the algorithm provided as a constant
	/// \details MIN_KEYLENGTH is provided in bytes, not bits
	CryptoPP_NV_2_CONSTANT(MIN_KEYLENGTH=T::MIN_KEYLENGTH)
	/// \brief The maximum key length used by the algorithm provided as a constant
	/// \details MIN_KEYLENGTH is provided in bytes, not bits
	CryptoPP_NV_2_CONSTANT(MAX_KEYLENGTH=T::MAX_KEYLENGTH)
	/// \brief The default key length used by the algorithm provided as a constant
	/// \details MIN_KEYLENGTH is provided in bytes, not bits
	CryptoPP_NV_2_CONSTANT(DEFAULT_KEYLENGTH=T::DEFAULT_KEYLENGTH)
	/// \brief The default IV requirements for the algorithm provided as a constant
	/// \details The default value is NOT_RESYNCHRONIZABLE. See IV_Requirement
	///  in cryptlib.h for allowed values.
	CryptoPP_NV_2_CONSTANT(IV_REQUIREMENT=IV_REQ)
...
class CryptoPP_NV_2_NO_VTABLE SimpleKeyingInterfaceImpl : public BASE
{
public:
...
class CryptoPP_NV_2_NO_VTABLE BlockCipherImpl : public AlgorithmImpl<SimpleKeyingInterfaceImpl<TwoBases<BASE, INFO> > >
{
public:
