...
// use "cl /EP /P /DCryptoPP_NV_2_GENERATE_X64_MASM sha.cpp" to generate MASM code
...
#if defined(CryptoPP_NV_2_DISABLE_SHA_ASM)
...
#if CryptoPP_NV_2_SHANI_AVAILABLE
...
//  cleared http://github.com/weidai11/CryptoPP_NV_2/issues/502
...
{
    CryptoPP_NV_2_ASSERT(state);
    CryptoPP_NV_2_ASSERT(data);
...
{
    CryptoPP_NV_2_ASSERT(input);
    CryptoPP_NV_2_ASSERT(length >= SHA1::BLOCKSIZE);
...
#if defined(CryptoPP_NV_2_X86_ASM_AVAILABLE)

ANONYMOUS_NAMESPACE_BEGIN

void CryptoPP_NV_2_FASTCALL SHA256_HashMultipleBlocks_SSE2(word32 *state, const word32 *data, size_t len)
{
...
// Unroll the use of CryptoPP_NV_2_BOOL_X64 in assembler math. The GAS assembler on X32 (version 2.25)
...
#define SWAP_COPY(i)        \
    ...
    SHA256_HashMultipleBlocks_SSE2    PROC FRAME
        ...
        .endprolog
        mov rdi, r8
        lea rsi, [?SHA256_K@CryptoPP_NV_2@@3QBIB + 48*4]
#endif
...
#endif    // CryptoPP_NV_2_X86_ASM_AVAILABLE
...
{
    CryptoPP_NV_2_ASSERT(input);
    CryptoPP_NV_2_ASSERT(length >= SHA256::BLOCKSIZE);
...
#endif
#if CryptoPP_NV_2_SSE2_ASM_AVAILABLE || CryptoPP_NV_2_X64_MASM_AVAILABLE
    if (HasSSE2())
    {
...
#if CryptoPP_NV_2_SSE2_ASM_AVAILABLE && (CryptoPP_NV_2_BOOL_X86)

ANONYMOUS_NAMESPACE_BEGIN

// No inlining due to https://github.com/weidai11/CryptoPP_NV_2/issues/684
...
CryptoPP_NV_2_NOINLINE CryptoPP_NV_2_NAKED
void CryptoPP_NV_2_FASTCALL SHA512_HashBlock_SSE2(word64 *state, const word64 *data)
{
#ifdef __GNUC__
    __asm__ __volatile__
    (
...
#endif    // CryptoPP_NV_2_SSE2_ASM_AVAILABLE
...
#endif    // Not CryptoPP_NV_2_GENERATE_X64_MASM
#endif    // Not CryptoPP_NV_2_IMPORTS
