...
#ifndef CryptoPP_NV_2_AUTHENC_H
#define CryptoPP_NV_2_AUTHENC_H
...
///   Encryption</A> on the Crypto++ wiki.
/// \since Crypto++ 5.6.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE AuthenticatedSymmetricCipherBase : public AuthenticatedSymmetricCipher
{
public:
...
protected:
	void UncheckedSetKey(const byte * key, unsigned int length,const CryptoPP_NV_2::NameValuePairs &params)
		{CryptoPP_NV_2_UNUSED(key), CryptoPP_NV_2_UNUSED(length), CryptoPP_NV_2_UNUSED(params); CryptoPP_NV_2_ASSERT(false);}
