...
#ifndef CryptoPP_NV_2_DH_H
#define CryptoPP_NV_2_DH_H
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DH_Domain<DL_GroupParameters_GFP_DefaultSafePrime>;

/// \brief Diffie-Hellman in GF(p)
/// \details DH() class is a typedef of DH_Domain(). The documentation that follows
///   does not exist. Rather the documentation was created in response to <a href="https://github.com/weidai11/CryptoPP_NV_2/issues/328">Issue
...
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/Diffie-Hellman">Diffie-Hellman on the Crypto++ wiki</a> and
