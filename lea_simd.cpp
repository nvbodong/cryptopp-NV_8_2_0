...
# define CryptoPP_NV_2_AVX512_ROTATE 1
# include <immintrin.h>
#endif
...
inline __m128i UnpackXMM(const __m128i& a, const __m128i& b, const __m128i& c, const __m128i& d)
{
    ...
    CryptoPP_NV_2_UNUSED(c); CryptoPP_NV_2_UNUSED(d);
    CryptoPP_NV_2_ASSERT(0);
...
{
    // Should not be instantiated
    CryptoPP_NV_2_UNUSED(v); CryptoPP_NV_2_ASSERT(0);
    return _mm_setzero_si128();
}
...
using CryptoPP_NV_2::uint8x16_p;
using CryptoPP_NV_2::uint32x4_p;
using CryptoPP_NV_2::uint64x2_p;
...
#if (CryptoPP_NV_2_ARM_NEON_AVAILABLE || CryptoPP_NV_2_SSSE3_AVAILABLE)
...
#if defined(CryptoPP_NV_2_ARM_NEON_AVAILABLE)
