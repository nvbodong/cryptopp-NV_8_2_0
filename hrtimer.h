#ifndef CryptoPP_NV_2_HRTIMER_H
#define CryptoPP_NV_2_HRTIMER_H

#include "config.h"

#if !defined(HIGHRES_TIMER_AVAILABLE) || (defined(CryptoPP_NV_2_WIN32_AVAILABLE) && !defined(THREAD_TIMER_AVAILABLE))
#include <time.h>
#endif
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE TimerBase
{
public:
...
class CryptoPP_NV_2_DLL Timer : public TimerBase
{
public:
