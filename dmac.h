...
#ifndef CryptoPP_NV_2_DMAC_H
#define CryptoPP_NV_2_DMAC_H
...
/// \since Crypto++ 3.1
template <class T>
class CryptoPP_NV_2_NO_VTABLE DMAC_Base : public SameKeyLengthAs<T>, public MessageAuthenticationCode
{
public:
