...
#ifndef CryptoPP_NV_2_SALSA_H
#define CryptoPP_NV_2_SALSA_H
...
# define CryptoPP_NV_2_DISABLE_SALSA_ASM 1
#endif
...
class CryptoPP_NV_2_NO_VTABLE Salsa20_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
protected:
...
class CryptoPP_NV_2_NO_VTABLE XSalsa20_Policy : public Salsa20_Policy
{
public:
	void CipherSetKey(const NameValuePairs &params, const byte *key, size_t length);
	void CipherResynchronize(byte *keystreamBuffer, const byte *IV, size_t length);
