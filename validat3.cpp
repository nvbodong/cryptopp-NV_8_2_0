...
# endif
	...
	// https://github.com/weidai11/CryptoPP_NV_2/issues/562
...
bool TestSettings()
{
...
#if defined(CryptoPP_NV_2_EXTENDED_VALIDATION)
	// App and library versions, http://github.com/weidai11/CryptoPP_NV_2/issues/371
	...
	// CryptoPP_NV_2_ALLOW_UNALIGNED_DATA_ACCESS removed at Issue 682.
...
#ifdef CryptoPP_NV_2_WORD128_AVAILABLE
...
#ifdef CryptoPP_NV_2_CPUID_AVAILABLE
...
bool TestRandomPool()
{
	...
	if(prng.get())
	{
		...
		// https://github.com/weidai11/CryptoPP_NV_2/issues/452
...
bool TestRDRAND()
{
	...
	if (rng.get())
	{
		...
		CryptoPP_NV_2_ASSERT(0 == maurer.BytesNeeded());
