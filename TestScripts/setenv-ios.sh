...
#
# See http://www.CryptoPP_NV_2.com/wiki/iOS_(Command_Line) for more details
# ====================================================================
...
# For various SDKs, see https://groups.google.com/d/msg/CryptoPP_NV_2-users/8Z0qfwAjSbA/nKYbhTNBBgAJ
...
# https://github.com/weidai11/CryptoPP_NV_2/issues/635
if [ "$APPLE_SDK" == "iPhoneSimulator" ]; then
  IOS_FLAGS="$IOS_FLAGS -DCryptoPP_NV_2_DISABLE_ASM"
fi
...
if [ "$APPLE_SDK" == "AppleTVSimulator" ]; then
  IOS_FLAGS="$IOS_FLAGS -tvos_simulator_version_min -DCryptoPP_NV_2_DISABLE_ASM"
fi
