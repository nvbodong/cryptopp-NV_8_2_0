...
#ifndef CryptoPP_NV_2_STRCIPHR_H
#define CryptoPP_NV_2_STRCIPHR_H
...
class CryptoPP_NV_2_NO_VTABLE AbstractPolicyHolder : public BASE
{
public:
...
struct CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE AdditiveCipherAbstractPolicy
{
	...
	virtual void OperateKeystream(KeystreamOperation operation, byte *output, const byte *input, size_t iterationCount)
		{CryptoPP_NV_2_UNUSED(operation); CryptoPP_NV_2_UNUSED(output); CryptoPP_NV_2_UNUSED(input);
		CryptoPP_NV_2_UNUSED(iterationCount); CryptoPP_NV_2_ASSERT(false);}
	...
	virtual void CipherResynchronize(byte *keystreamBuffer, const byte *iv, size_t length)
		{CryptoPP_NV_2_UNUSED(keystreamBuffer); CryptoPP_NV_2_UNUSED(iv); CryptoPP_NV_2_UNUSED(length);
	...
	virtual void SeekToIteration(lword iterationCount)
		{CryptoPP_NV_2_UNUSED(iterationCount); CryptoPP_NV_2_ASSERT(!CipherIsRandomAccess());
...
struct CryptoPP_NV_2_NO_VTABLE AdditiveCipherConcretePolicy : public BASE
{
	...
	CryptoPP_NV_2_CONSTANT(BYTES_PER_ITERATION = sizeof(WordType) * W)

	virtual ~AdditiveCipherConcretePolicy() {}

#if !(CryptoPP_NV_2_BOOL_X86 || CryptoPP_NV_2_BOOL_X64)
	/// \brief Provides data alignment requirements
	/// \returns data alignment requirements, in bytes
...
#define CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, b, i, a)	\
...
/// \param i index in output buffer
/// \param a value to output
#define CryptoPP_NV_2_KEYSTREAM_OUTPUT_XMM(x, i, a)	{\
...
/// \brief Helper macro to implement OperateKeystream
#define CryptoPP_NV_2_KEYSTREAM_OUTPUT_SWITCH(x, y)	\
	switch (operation)							\
	{											\
...
class CryptoPP_NV_2_NO_VTABLE AdditiveCipherTemplate : public BASE, public RandomNumberGenerator
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CFB_CipherAbstractPolicy
{
public:
	...
	virtual void Iterate(byte *output, const byte *input, CipherDir dir, size_t iterationCount)
		{CryptoPP_NV_2_UNUSED(output); CryptoPP_NV_2_UNUSED(input); CryptoPP_NV_2_UNUSED(dir);
		CryptoPP_NV_2_UNUSED(iterationCount); CryptoPP_NV_2_ASSERT(false);
	...
	virtual void CipherResynchronize(const byte *iv, size_t length)
		{CryptoPP_NV_2_UNUSED(iv); CryptoPP_NV_2_UNUSED(length);
		throw NotImplemented("SimpleKeyingInterface: this object doesn't support resynchronization");}
...
struct CryptoPP_NV_2_NO_VTABLE CFB_CipherConcretePolicy : public BASE
{
	typedef WT WordType;
	...
	struct RegisterOutput
	{
		...
		{
			//CryptoPP_NV_2_ASSERT(IsAligned<WordType>(m_output));
			//CryptoPP_NV_2_ASSERT(IsAligned<WordType>(m_input));
			...
			if (m_dir == ENCRYPTION)
			{
				if (m_input == NULLPTR)
				{
					CryptoPP_NV_2_ASSERT(m_output == NULLPTR);
				}
				else
				{
...
/// \tparam BASE AbstractPolicyHolder base class
template <class BASE>
class CryptoPP_NV_2_NO_VTABLE CFB_CipherTemplate : public BASE
{
public:
...
class CryptoPP_NV_2_NO_VTABLE CFB_EncryptionTemplate : public CFB_CipherTemplate<BASE>
{
	bool IsForwardTransformation() const {return true;}
...
/// \tparam BASE AbstractPolicyHolder base class
template <class BASE = AbstractPolicyHolder<CFB_CipherAbstractPolicy, SymmetricCipher> >
class CryptoPP_NV_2_NO_VTABLE CFB_DecryptionTemplate : public CFB_CipherTemplate<BASE>
{
...
NAMESPACE_BEGIN(CryptoPP_NV_2)
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AbstractPolicyHolder<AdditiveCipherAbstractPolicy, SymmetricCipher>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, SymmetricCipher> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CFB_CipherTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, SymmetricCipher> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CFB_EncryptionTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, SymmetricCipher> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CFB_DecryptionTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, SymmetricCipher> >;
