...
// report, and other goodies at http://www.CryptoPP_NV_2.com/wiki/VIA_Padlock.
...
#if defined(CryptoPP_NV_2_X86_ASM_AVAILABLE) && defined(__GNUC__)
	while (size)
	{
...
#elif defined(CryptoPP_NV_2_X86_ASM_AVAILABLE) && defined(_MSC_VER) && defined(_M_IX86)
	while (size)
	{
