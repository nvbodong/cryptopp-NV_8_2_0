...
#ifndef CryptoPP_NV_2_SM4_H
#define CryptoPP_NV_2_SM4_H
...
# ifndef CryptoPP_NV_2_DISABLE_SM4_SIMD
#  define CryptoPP_NV_2_SM4_ADVANCED_PROCESS_BLOCKS 1
# endif
#endif
...
/// \sa <A HREF="http://eprint.iacr.org/2008/329.pdf">SMS4 Encryption Algorithm for Wireless Networks</A>
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE SM4 : public SM4_Info, public BlockCipherDocumentation
{
public:
    /// \brief SM4 block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SM4_Info>
    {
    protected:
...
#if CryptoPP_NV_2_SM4_ADVANCED_PROCESS_BLOCKS
