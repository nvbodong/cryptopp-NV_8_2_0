...
#ifndef CryptoPP_NV_2_SIMPLE_H
#define CryptoPP_NV_2_SIMPLE_H
...
class CryptoPP_NV_2_NO_VTABLE ClonableImpl : public BASE
{
public:
...
class CryptoPP_NV_2_NO_VTABLE AlgorithmImpl : public BASE
{
public:
	...
	static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return ALGORITHM_INFO::StaticAlgorithmName();}
	/// \brief The algorithm name
	/// \returns the algorithm name
...
class CryptoPP_NV_2_DLL InvalidKeyLength : public InvalidArgument
{
public:
...
class CryptoPP_NV_2_DLL InvalidRounds : public InvalidArgument
{
public:
...
class CryptoPP_NV_2_DLL InvalidBlockSize : public InvalidArgument
{
public:
...
class CryptoPP_NV_2_DLL InvalidDerivedLength : public InvalidArgument
{
public:
...
class CryptoPP_NV_2_DLL InvalidPersonalizationLength : public InvalidArgument
{
public:
...
class CryptoPP_NV_2_DLL InvalidSaltLength : public InvalidArgument
{
public:
...
template <class T>
class CryptoPP_NV_2_NO_VTABLE Bufferless : public T
{
public:
	bool IsolatedFlush(bool hardFlush, bool blocking)
		{CryptoPP_NV_2_UNUSED(hardFlush); CryptoPP_NV_2_UNUSED(blocking); return false;}
};

/// \brief Base class for unflushable filters
/// \tparam T the class or type
template <class T>
class CryptoPP_NV_2_NO_VTABLE Unflushable : public T
{
public:
	bool Flush(bool completeFlush, int propagation=-1, bool blocking=true)
		{return ChannelFlush(DEFAULT_CHANNEL, completeFlush, propagation, blocking);}
	bool IsolatedFlush(bool hardFlush, bool blocking)
		{CryptoPP_NV_2_UNUSED(hardFlush); CryptoPP_NV_2_UNUSED(blocking); CryptoPP_NV_2_ASSERT(false); return false;}
...
template <class T>
class CryptoPP_NV_2_NO_VTABLE InputRejecting : public T
{
public:
	...
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
		{CryptoPP_NV_2_UNUSED(inString); CryptoPP_NV_2_UNUSED(length); CryptoPP_NV_2_UNUSED(messageEnd); CryptoPP_NV_2_UNUSED(blocking); throw InputRejected();}
	//@}
	...
	bool IsolatedMessageSeriesEnd(bool blocking)
		{CryptoPP_NV_2_UNUSED(blocking); throw InputRejected();}
	size_t ChannelPut2(const std::string &channel, const byte *inString, size_t length, int messageEnd, bool blocking)
		{CryptoPP_NV_2_UNUSED(channel); CryptoPP_NV_2_UNUSED(inString); CryptoPP_NV_2_UNUSED(length); CryptoPP_NV_2_UNUSED(messageEnd); CryptoPP_NV_2_UNUSED(blocking); throw InputRejected();}
	bool ChannelMessageSeriesEnd(const std::string& channel, int messageEnd, bool blocking)
		{CryptoPP_NV_2_UNUSED(channel); CryptoPP_NV_2_UNUSED(messageEnd); CryptoPP_NV_2_UNUSED(blocking); throw InputRejected();}
	//@}
};
...
template <class T>
class CryptoPP_NV_2_NO_VTABLE CustomFlushPropagation : public T
{
public:
	///	\name SIGNALS
	//@{
...
/// \tparam T BufferedTransformation derived class
template <class T>
class CryptoPP_NV_2_NO_VTABLE CustomSignalPropagation : public CustomFlushPropagation<T>
{
public:
...
/// \details T should be a BufferedTransformation derived class
template <class T>
class CryptoPP_NV_2_NO_VTABLE Multichannel : public CustomFlushPropagation<T>
{
public:
...
//		{PropagateMessageSeriesEnd(propagation, channel);}
	byte * ChannelCreatePutSpace(const std::string &channel, size_t &size)
		{CryptoPP_NV_2_UNUSED(channel); size = 0; return NULLPTR;}
...
/// \tparam T BufferedTransformation derived class
template <class T>
class CryptoPP_NV_2_NO_VTABLE AutoSignaling : public T
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Store : public AutoSignaling<InputRejecting<BufferedTransformation> >
{
public:
...
///   more details.
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Sink : public BufferedTransformation
{
public:
	size_t TransferTo2(BufferedTransformation &target, lword &transferBytes, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true)
		{CryptoPP_NV_2_UNUSED(target); CryptoPP_NV_2_UNUSED(transferBytes); CryptoPP_NV_2_UNUSED(channel); CryptoPP_NV_2_UNUSED(blocking); transferBytes = 0; return 0;}
	size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const
		{CryptoPP_NV_2_UNUSED(target); CryptoPP_NV_2_UNUSED(begin); CryptoPP_NV_2_UNUSED(end); CryptoPP_NV_2_UNUSED(channel); CryptoPP_NV_2_UNUSED(blocking); return 0;}
};
...
class CryptoPP_NV_2_DLL BitBucket : public Bufferless<Sink>
{
public:
	std::string AlgorithmName() const {return "BitBucket";}
	void IsolatedInitialize(const NameValuePairs &params)
		{CryptoPP_NV_2_UNUSED(params);}
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
		{CryptoPP_NV_2_UNUSED(inString); CryptoPP_NV_2_UNUSED(length); CryptoPP_NV_2_UNUSED(messageEnd); CryptoPP_NV_2_UNUSED(blocking); return 0;}
};
