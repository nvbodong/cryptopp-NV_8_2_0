...
#ifndef CryptoPP_NV_2_MISC_H
#define CryptoPP_NV_2_MISC_H

#include "config.h"

#if !defined(CryptoPP_NV_2_DOXYGEN_PROCESSING)

#if (CryptoPP_NV_2_MSC_VERSION)
# pragma warning(push)
# pragma warning(disable: 4146 4514)
# if (CryptoPP_NV_2_MSC_VERSION >= 1400)
...
#include "smartptr.h"
		...
		#define _interlockedbittestandset CryptoPP_NV_2_DISABLED_INTRINSIC_1
		#define _interlockedbittestandreset CryptoPP_NV_2_DISABLED_INTRINSIC_2
		#define _interlockedbittestandset64 CryptoPP_NV_2_DISABLED_INTRINSIC_3
		#define _interlockedbittestandreset64 CryptoPP_NV_2_DISABLED_INTRINSIC_4
		#include <intrin.h>
		#undef _interlockedbittestandset
		#undef _interlockedbittestandreset
		#undef _interlockedbittestandset64
		#undef _interlockedbittestandreset64
		#define CryptoPP_NV_2_FAST_ROTATE(x) 1
	#elif _MSC_VER >= 1300
		#define CryptoPP_NV_2_FAST_ROTATE(x) ((x) == 32 | (x) == 64)
	#else
		#define CryptoPP_NV_2_FAST_ROTATE(x) ((x) == 32)
	#endif
#elif (defined(__MWERKS__) && TARGET_CPU_PPC) || \
	(defined(__GNUC__) && (defined(_ARCH_PWR2) || defined(_ARCH_PWR) || defined(_ARCH_PPC) || defined(_ARCH_PPC64) || defined(_ARCH_COM)))
	#define CryptoPP_NV_2_FAST_ROTATE(x) ((x) == 32)
#elif defined(__GNUC__) && (CryptoPP_NV_2_BOOL_X64 || CryptoPP_NV_2_BOOL_X32 || CryptoPP_NV_2_BOOL_X86)	// depend on GCC's peephole optimization to generate rotate instructions
	#define CryptoPP_NV_2_FAST_ROTATE(x) 1
#else
	#define CryptoPP_NV_2_FAST_ROTATE(x) 0
#endif
...
#define CryptoPP_NV_2_BYTESWAP_AVAILABLE
#include <byteswap.h>
#endif
...
#endif  // CryptoPP_NV_2_DOXYGEN_PROCESSING

#if CryptoPP_NV_2_DOXYGEN_PROCESSING
...
#define CryptoPP_NV_2_COMPILE_ASSERT(expr) { ... }
#else // CryptoPP_NV_2_DOXYGEN_PROCESSING
template <bool b>
...
#define CryptoPP_NV_2_COMPILE_ASSERT(assertion) CryptoPP_NV_2_COMPILE_ASSERT_INSTANCE(assertion, __LINE__)
#if defined(CryptoPP_NV_2_EXPORTS) || defined(CryptoPP_NV_2_IMPORTS)
#define CryptoPP_NV_2_COMPILE_ASSERT_INSTANCE(assertion, instance)
#else
# if defined(__GNUC__)
#  define CryptoPP_NV_2_COMPILE_ASSERT_INSTANCE(assertion, instance) \
		static CompileAssert<(assertion)> \
		CryptoPP_NV_2_ASSERT_JOIN(CryptoPP_NV_2_CryptoPP_NV_2_ASSERT_, instance) __attribute__ ((unused))
# else
#  define CryptoPP_NV_2_COMPILE_ASSERT_INSTANCE(assertion, instance) \
		static CompileAssert<(assertion)> \
		CryptoPP_NV_2_ASSERT_JOIN(CryptoPP_NV_2_CryptoPP_NV_2_ASSERT_, instance)
# endif // __GNUC__
#endif
#define CryptoPP_NV_2_ASSERT_JOIN(X, Y) CryptoPP_NV_2_DO_ASSERT_JOIN(X, Y)
#define CryptoPP_NV_2_DO_ASSERT_JOIN(X, Y) X##Y
...
class CryptoPP_NV_2_DLL Empty
{
};

#if !defined(CryptoPP_NV_2_DOXYGEN_PROCESSING)
template <class BASE1, class BASE2>
class CryptoPP_NV_2_NO_VTABLE TwoBases : public BASE1, public BASE2
{
};

template <class BASE1, class BASE2, class BASE3>
class CryptoPP_NV_2_NO_VTABLE ThreeBases : public BASE1, public BASE2, public BASE3
{
};
#endif // CryptoPP_NV_2_DOXYGEN_PROCESSING
...
#else
#if defined(CryptoPP_NV_2_CXX11_ATOMICS)
...
public:
	...
	CryptoPP_NV_2_NOINLINE const T & Ref(CryptoPP_NV_2_NOINLINE_DOTDOTDOT) const;
...
template <class T, class F, int instance>
  const T & Singleton<T, F, instance>::Ref(CryptoPP_NV_2_NOINLINE_DOTDOTDOT) const
{
#if defined(CryptoPP_NV_2_CXX11_ATOMICS) && defined(CryptoPP_NV_2_CXX11_SYNCHRONIZATION) && defined(CryptoPP_NV_2_CXX11_DYNAMIC_INIT)
...
inline byte* BytePtr(std::string& str)
{
	...
	CryptoPP_NV_2_ASSERT(str.empty() == false);
...
#if (!__STDC_WANT_SECURE_LIB__ && !defined(_MEMORY_S_DEFINED)) || defined(CryptoPP_NV_2_WANT_SECURE_LIB)
...
///   make the symbols available if <tt>CryptoPP_NV_2_WANT_SECURE_LIB</tt> is defined.
///   <tt>CryptoPP_NV_2_WANT_SECURE_LIB</tt> is in config.h, but it is disabled by default.
...
{
	// Safer functions on Windows for C&A, http://github.com/weidai11/CryptoPP_NV_2/issues/55

	// Pointers must be valid; otherwise undefined behavior
	CryptoPP_NV_2_ASSERT(dest != NULLPTR); CryptoPP_NV_2_ASSERT(src != NULLPTR);
	// Restricted pointers. We want to check ranges, but it is not clear how to do it.
	CryptoPP_NV_2_ASSERT(src != dest);
	// Destination buffer must be large enough to satsify request
	CryptoPP_NV_2_ASSERT(sizeInBytes >= count);
...
# define memcpy_s CryptoPP_NV_2::memcpy_s
# define memmove_s CryptoPP_NV_2::memmove_s
#endif
...
#if CryptoPP_NV_2_GCC_VERSION >= 30001
...
# if (CryptoPP_NV_2_LLVM_CLANG_VERSION >= 20800) || (CryptoPP_NV_2_APPLE_CLANG_VERSION >= 30000)
#  pragma GCC diagnostic ignored "-Wtautological-compare"
# elif (CryptoPP_NV_2_GCC_VERSION >= 40300)
...
{
	CryptoPP_NV_2_COMPILE_ASSERT((sizeof(T1)<=sizeof(T2) && T2(-1)>0) || (sizeof(T1)>sizeof(T2) && T1(-1)>0));
...
#define CryptoPP_NV_2_GET_BYTE_AS_BYTE(x, y) byte((x)>>(8*(y)))
...
inline unsigned int TrailingZeros(word32 v)
{
	...
	CryptoPP_NV_2_ASSERT(v != 0);
#if defined(__BMI__)
	return (unsigned int)_tzcnt_u32(v);
#elif defined(__GNUC__) && (CryptoPP_NV_2_GCC_VERSION >= 30400)
...
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API xorbuf(byte *buf, const byte *mask, size_t count);
...
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API xorbuf(byte *output, const byte *input, const byte *mask, size_t count);
...
///   equally sized.
/// \sa ModPowerOf2
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API VerifyBufsEqual(const byte *buf1, const byte *buf2, size_t count);
...
///  HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/364">Issue 364,
...
{
	CryptoPP_NV_2_ASSERT(std::numeric_limits<T>::is_specialized);
...
//   see http://github.com/weidai11/CryptoPP_NV_2/issues/364
#if defined(CryptoPP_NV_2_WORD128_AVAILABLE)
template<>
...
{
	CryptoPP_NV_2_ASSERT(IsPowerOf2(b));
...
{
	// http://github.com/weidai11/CryptoPP_NV_2/issues/364
#if !defined(CryptoPP_NV_2_APPLE_CLANG_VERSION) || (CryptoPP_NV_2_APPLE_CLANG_VERSION >= 80000)
	CryptoPP_NV_2_ASSERT(std::numeric_limits<T1>::is_integer);
	CryptoPP_NV_2_ASSERT(std::numeric_limits<T2>::is_integer);
#endif

	CryptoPP_NV_2_ASSERT(!std::numeric_limits<T1>::is_signed || n > 0);
	CryptoPP_NV_2_ASSERT(!std::numeric_limits<T2>::is_signed || m > 0);
...
{
#if defined(CryptoPP_NV_2_CXX11_ALIGNOF)
	return alignof(T);
#elif (_MSC_VER >= 1300)
	return __alignof(T);
	...
	return __alignof__(T);
#elif CryptoPP_NV_2_BOOL_SLOW_WORD64
...
#if (CryptoPP_NV_2_LITTLE_ENDIAN)
	typedef LittleEndian NativeByteOrder;
#elif (CryptoPP_NV_2_BIG_ENDIAN)
...
///  If CryptoPP_NV_2_LITTLE_ENDIAN is set in config.h, then
///  GetNativeByteOrder returns LittleEndian. If CryptoPP_NV_2_BIG_ENDIAN
...
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API CallNewHandler();
...
{
	CryptoPP_NV_2_ASSERT(inout != NULLPTR); CryptoPP_NV_2_ASSERT(size < INT_MAX);
...
{
	CryptoPP_NV_2_ASSERT(output != NULLPTR); CryptoPP_NV_2_ASSERT(input != NULLPTR); CryptoPP_NV_2_ASSERT(size < INT_MAX);
...
#if !defined(CryptoPP_NV_2_DISABLE_ASM) && \
    (_MSC_VER >= 1400 || defined(__GNUC__)) && \
    (CryptoPP_NV_2_BOOL_X64 || CryptoPP_NV_2_BOOL_X86)
...
#endif	// CryptoPP_NV_2_BOOL_X64 || CryptoPP_NV_2_BOOL_X86

#if !defined(CryptoPP_NV_2_DISABLE_ASM) && (_MSC_VER >= 1700) && defined(_M_ARM)
template<> inline void SecureWipeBuffer(byte *buf, size_t n)
{
...
///   <A HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/779">Issue 779</A>
CryptoPP_NV_2_DLL void* CryptoPP_NV_2_API AlignedAllocate(size_t size);
...
///   <A HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/779">Issue 779</A>
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API AlignedDeallocate(void *ptr);
...
///   <A HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/779">Issue 779</A>
CryptoPP_NV_2_DLL void * CryptoPP_NV_2_API UnalignedAllocate(size_t size);
...
///   <A HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/779">Issue 779</A>
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API UnalignedDeallocate(void *ptr);
...
template <unsigned int R, class T> inline T rotlConstant(T x)
{
	...
	CryptoPP_NV_2_CONSTANT(THIS_SIZE = sizeof(T)*8)
	CryptoPP_NV_2_CONSTANT(MASK = THIS_SIZE-1)
	CryptoPP_NV_2_ASSERT(R < THIS_SIZE);
...
template <class T> inline T rotlFixed(T x, unsigned int y)
{
	...
	CryptoPP_NV_2_CONSTANT(THIS_SIZE = sizeof(T)*8)
	CryptoPP_NV_2_CONSTANT(MASK = THIS_SIZE-1)
	CryptoPP_NV_2_ASSERT(y < THIS_SIZE);
...
template<> inline word32 rotlFixed<word32>(word32 x, unsigned int y)
{
	...
	CryptoPP_NV_2_ASSERT(y < 8*sizeof(x));
...
{
#if defined(CryptoPP_NV_2_BYTESWAP_AVAILABLE)
...
{
#if defined(__GNUC__) && defined(CryptoPP_NV_2_X86_ASM_AVAILABLE)
	__asm__ ("bswap %0" : "=r" (value) : "0" (value));
	return value;
#elif defined(CryptoPP_NV_2_BYTESWAP_AVAILABLE)
	return bswap_32(value);
#elif defined(__MWERKS__) && TARGET_CPU_PPC
	return (word32)__lwbrx(&value,0);
#elif (_MSC_VER >= 1400) || (defined(_MSC_VER) && !defined(_DLL))
	return _byteswap_ulong(value);
#elif CryptoPP_NV_2_FAST_ROTATE(32) && !defined(__xlC__)
...
{
#if defined(__GNUC__) && defined(CryptoPP_NV_2_X86_ASM_AVAILABLE) && defined(__x86_64__)
	__asm__ ("bswap %0" : "=r" (value) : "0" (value));
	return value;
#elif defined(CryptoPP_NV_2_BYTESWAP_AVAILABLE)
...
{
#if CryptoPP_NV_2_BOOL_SLOW_WORD64
...
inline T BitReverse(T value)
{
	...
	{
		CryptoPP_NV_2_ASSERT(sizeof(T) == 8);
...
void ByteReverse(T *out, const T *in, size_t byteCount)
{
	...
	CryptoPP_NV_2_ASSERT(byteCount % sizeof(T) == 0);
	CryptoPP_NV_2_ASSERT(IsAligned<T>(in));
	CryptoPP_NV_2_ASSERT(IsAligned<T>(out));
...
inline void GetUserKey(ByteOrder order, T *out, size_t outlen, const byte *in, size_t inlen)
{
	...
	CryptoPP_NV_2_ASSERT(inlen <= outlen*U);
...
inline void UnalignedbyteNonTemplate(ByteOrder order, byte *block, word16 value, const byte *xorBlock)
{
	if (order == BIG_ENDIAN_ORDER)
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[1] = xorBlock[1] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
		}
		else
		{
			block[0] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[1] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
		}
	}
	else
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
			block[1] = xorBlock[1] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
		}
		else
		{
			block[0] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
			block[1] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
		}
	}
}
...
inline void UnalignedbyteNonTemplate(ByteOrder order, byte *block, word32 value, const byte *xorBlock)
{
	if (order == BIG_ENDIAN_ORDER)
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
			block[1] = xorBlock[1] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[2] = xorBlock[2] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[3] = xorBlock[3] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
		}
		else
		{
			block[0] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
			block[1] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[2] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[3] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
		}
	}
	else
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
			block[1] = xorBlock[1] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[2] = xorBlock[2] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[3] = xorBlock[3] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
		}
		else
		{
			block[0] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
			block[1] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[2] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[3] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
		}
	}
}
...
inline void UnalignedbyteNonTemplate(ByteOrder order, byte *block, word64 value, const byte *xorBlock)
{
	if (order == BIG_ENDIAN_ORDER)
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 7);
			block[1] = xorBlock[1] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 6);
			block[2] = xorBlock[2] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 5);
			block[3] = xorBlock[3] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 4);
			block[4] = xorBlock[4] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
			block[5] = xorBlock[5] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[6] = xorBlock[6] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[7] = xorBlock[7] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
		}
		else
		{
			block[0] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 7);
			block[1] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 6);
			block[2] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 5);
			block[3] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 4);
			block[4] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
			block[5] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[6] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 1);
			block[7] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
		}
	}
	else
	{
		if (xorBlock)
		{
			...
			block[2] = xorBlock[2] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[3] = xorBlock[3] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
			block[4] = xorBlock[4] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 4);
			block[5] = xorBlock[5] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 5);
			block[6] = xorBlock[6] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 6);
			block[7] = xorBlock[7] ^ CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 7);
		}
		else
		{
			block[0] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 0);
			...
			block[2] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 2);
			block[3] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 3);
			block[4] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 4);
			block[5] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 5);
			block[6] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 6);
			block[7] = CryptoPP_NV_2_GET_BYTE_AS_BYTE(value, 7);
		}
	}
}
...
{
	CryptoPP_NV_2_UNUSED(assumeAligned);
...
public:
	...
	{
		CryptoPP_NV_2_COMPILE_ASSERT(sizeof(U) >= sizeof(T));
...
template<> struct SafeShifter<true>
{
	...
	{
		CryptoPP_NV_2_UNUSED(value); CryptoPP_NV_2_UNUSED(bits);
		return 0;
	}
...
#ifdef CryptoPP_NV_2_CXX11_LAMBDA
...
#define CryptoPP_NV_2_BLOCK_1(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+0);}     size_t SS1() {return       sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_2(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS1());} size_t SS2() {return SS1()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_3(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS2());} size_t SS3() {return SS2()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_4(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS3());} size_t SS4() {return SS3()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_5(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS4());} size_t SS5() {return SS4()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_6(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS5());} size_t SS6() {return SS5()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_7(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS6());} size_t SS7() {return SS6()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCK_8(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS7());} size_t SS8() {return SS7()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CryptoPP_NV_2_BLOCKS_END(i) size_t SST() {return SS##i();} void AllocateBlocks() {m_aggregate.New(SST());} AlignedSecByteBlock m_aggregate;
