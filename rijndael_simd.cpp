...
#if defined(CryptoPP_NV_2_POWER8_AES_AVAILABLE)
# include "adv_simd.h"
# include "ppc_simd.h"
#endif
...
bool CPU_ProbeAES()
{
    ...
    return false;
#elif (CryptoPP_NV_2_ARM_AES_AVAILABLE)
...
#else
    return false;
#endif  // CryptoPP_NV_2_ARM_AES_AVAILABLE
}
...
#endif  // CryptoPP_NV_2_AESNI_AVAILABLE
...
{
    CryptoPP_NV_2_ASSERT(IsAlignedOn(subkeys, 16));
    const byte *keys = reinterpret_cast<const byte*>(subkeys);
...
#endif  // CryptoPP_NV_2_POWER8_AES_AVAILABLE
NAMESPACE_END
