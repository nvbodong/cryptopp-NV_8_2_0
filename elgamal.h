...
#ifndef CryptoPP_NV_2_ELGAMAL_H
#define CryptoPP_NV_2_ELGAMAL_H
...
/// \since Crypto++ 1.0
class CryptoPP_NV_2_NO_VTABLE ElGamalBase : public DL_KeyAgreementAlgorithm_DH<Integer, NoCofactorMultiplication>,
...
public:
	...
	{
		CryptoPP_NV_2_UNUSED(groupParams), CryptoPP_NV_2_UNUSED(ephemeralPublicKey), CryptoPP_NV_2_UNUSED(derivationParams);
		agreedElement.Encode(derivedKey, derivedLength);
	}

	size_t GetSymmetricKeyLength(size_t plainTextLength) const
	{
		CryptoPP_NV_2_UNUSED(plainTextLength);
...
/// \sa <A HREF="https://github.com/weidai11/CryptoPP_NV_2/commit/a5a684d92986e8e2">Commit a5a684d92986e8e2</A>
struct ElGamalKeys
{
...
struct ElGamal
{
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ElgamalEnc/Crypto++Padding";}
