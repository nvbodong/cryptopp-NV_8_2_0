...
#ifndef CryptoPP_NV_2_ASN_H
#define CryptoPP_NV_2_ASN_H
...
class CryptoPP_NV_2_DLL UnknownOID : public BERDecodeErr
{
public:
...
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API DERLengthEncode(BufferedTransformation &bt, lword length);
...
CryptoPP_NV_2_DLL bool CryptoPP_NV_2_API BERLengthDecode(BufferedTransformation &bt, size_t &length);

/// \brief DER encode NULL
/// \param bt BufferedTransformation object for writing
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API DEREncodeNull(BufferedTransformation &bt);

/// \brief BER decode NULL
/// \param bt BufferedTransformation object for reading
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API BERDecodeNull(BufferedTransformation &bt);
...
/// \returns the number of octets used for the encoding
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API DEREncodeOctetString(BufferedTransformation &bt, const byte *str, size_t strLen);

/// \brief DER encode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the string to encode
/// \returns the number of octets used for the encoding
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API DEREncodeOctetString(BufferedTransformation &bt, const SecByteBlock &str);

/// \brief BER decode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \returns the number of octets used for the encoding
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API BERDecodeOctetString(BufferedTransformation &bt, SecByteBlock &str);

/// \brief BER decode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \returns the number of octets used for the encoding
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API BERDecodeOctetString(BufferedTransformation &bt, BufferedTransformation &str);
...
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API DEREncodeTextString(BufferedTransformation &bt, const std::string &str, byte asnTag);
...
/// \param asnTag the ASN.1 type
/// \details DEREncodeTextString() can be used for UTF8_STRING, PRINTABLE_STRING, and IA5_STRING
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API BERDecodeTextString(BufferedTransformation &bt, std::string &str, byte asnTag);
...
/// \returns the number of octets used for the encoding
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API DEREncodeBitString(BufferedTransformation &bt, const byte *str, size_t strLen, unsigned int unusedBits=0);

/// \brief DER decode bit string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \param unusedBits the number of unused bits
CryptoPP_NV_2_DLL size_t CryptoPP_NV_2_API BERDecodeBitString(BufferedTransformation &bt, SecByteBlock &str, unsigned int &unusedBits);

/// \brief BER decode and DER re-encode
/// \param bt BufferedTransformation object for writing
/// \param dest BufferedTransformation object
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API DERReencode(BufferedTransformation &bt, BufferedTransformation &dest);

/// \brief Object Identifier
class CryptoPP_NV_2_DLL OID
{
public:
	virtual ~OID() {}
...
class CryptoPP_NV_2_DLL BERGeneralDecoder : public Store
{
public:
	...
	lword RemainingLength() const {CryptoPP_NV_2_ASSERT(m_definiteLength); return m_length;}
...
private:
	...
	void StoreInitialize(const NameValuePairs &parameters)
		{CryptoPP_NV_2_UNUSED(parameters); CryptoPP_NV_2_ASSERT(false);}
	lword ReduceLength(lword delta);
};

/// \brief DER General Encoder
class CryptoPP_NV_2_DLL DERGeneralEncoder : public ByteQueue
{
public:
...
class CryptoPP_NV_2_DLL BERSequenceDecoder : public BERGeneralDecoder
{
public:
...
class CryptoPP_NV_2_DLL DERSequenceEncoder : public DERGeneralEncoder
{
public:
...
class CryptoPP_NV_2_DLL BERSetDecoder : public BERGeneralDecoder
{
public:
...
class CryptoPP_NV_2_DLL DERSetEncoder : public DERGeneralEncoder
{
public:
...
template <class BASE>
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE ASN1CryptoMaterial : public ASN1Object, public BASE
{
public:
...
class CryptoPP_NV_2_DLL X509PublicKey : public ASN1CryptoMaterial<PublicKey>
{
public:
...
class CryptoPP_NV_2_DLL PKCS8PrivateKey : public ASN1CryptoMaterial<PrivateKey>
{
public:
...
#else
inline bool operator==(const ::CryptoPP_NV_2::OID &lhs, const ::CryptoPP_NV_2::OID &rhs)
	{return lhs.m_values == rhs.m_values;}
inline bool operator!=(const ::CryptoPP_NV_2::OID &lhs, const ::CryptoPP_NV_2::OID &rhs)
	{return lhs.m_values != rhs.m_values;}
inline bool operator<(const ::CryptoPP_NV_2::OID &lhs, const ::CryptoPP_NV_2::OID &rhs)
	{return std::lexicographical_compare(lhs.m_values.begin(), lhs.m_values.end(), rhs.m_values.begin(), rhs.m_values.end());}
inline ::CryptoPP_NV_2::OID operator+(const ::CryptoPP_NV_2::OID &lhs, unsigned long rhs)
	{return ::CryptoPP_NV_2::OID(lhs)+=rhs;}
#endif
