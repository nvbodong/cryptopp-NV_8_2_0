...
#ifndef CryptoPP_NV_2_THREEFISH_H
#define CryptoPP_NV_2_THREEFISH_H
...
/// \sa Threefish256, Threefish512, Threefish1024, <a href="http://www.CryptoPP_NV_2.com/wiki/Threefish">Threefish</a>
/// \since Crypto++ 6.0
template <unsigned int BS>
struct CryptoPP_NV_2_NO_VTABLE Threefish_Base
{
    ...
    void SetTweak(const NameValuePairs &params)
    {
        ...
        if (params.GetValue(Name::Tweak(), t))
        {
            ...
            CryptoPP_NV_2_ASSERT(t.size() == 16);
...
/// \sa Threefish512, Threefish1024, <a href="http://www.CryptoPP_NV_2.com/wiki/Threefish">Threefish</a>
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE Threefish256 : public Threefish_Info<32>, public BlockCipherDocumentation
{
public:
    /// \brief Threefish block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : public Threefish_Base<32>, public BlockCipherImpl<Threefish_Info<32> >
    {
    protected:
...
/// \note Crypto++ provides a byte oriented implementation
/// \sa Threefish256, Threefish1024, <a href="http://www.CryptoPP_NV_2.com/wiki/Threefish">Threefish</a>
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE Threefish512 : public Threefish_Info<64>, public BlockCipherDocumentation
{
public:
    /// \brief Threefish block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : public Threefish_Base<64>, public BlockCipherImpl<Threefish_Info<64> >
    {
    protected:
        void UncheckedSetKey(const byte *userKey, unsigned int keyLength, const NameValuePairs &params);
    };
...
/// \note Crypto++ provides a byte oriented implementation
/// \sa Threefish256, Threefish512, <a href="http://www.CryptoPP_NV_2.com/wiki/Threefish">Threefish</a>
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE Threefish1024 : public Threefish_Info<128>, public BlockCipherDocumentation
{
public:
    /// \brief Threefish block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : public Threefish_Base<128>, public BlockCipherImpl<Threefish_Info<128> >
    {
    protected:
        void UncheckedSetKey(const byte *userKey, unsigned int keyLength, const NameValuePairs &params);
    };
...
#endif  // CryptoPP_NV_2_THREEFISH_H
