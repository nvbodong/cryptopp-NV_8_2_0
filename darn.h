...
#ifndef CryptoPP_NV_2_DARN_H
#define CryptoPP_NV_2_DARN_H
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "DARN"; }
