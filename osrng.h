...
#ifndef CryptoPP_NV_2_OSRNG_H
#define CryptoPP_NV_2_OSRNG_H
...
class CryptoPP_NV_2_DLL OS_RNG_Err : public Exception
{
public:
...
class CryptoPP_NV_2_DLL MicrosoftCryptoProvider
{
public:
...
class CryptoPP_NV_2_DLL NonblockingRng : public RandomNumberGenerator
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "NonblockingRng"; }
...
#if defined(BLOCKING_RNG_AVAILABLE) || defined(CryptoPP_NV_2_DOXYGEN_PROCESSING)
...
class CryptoPP_NV_2_DLL BlockingRng : public RandomNumberGenerator
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "BlockingRng"; }
...
CryptoPP_NV_2_DLL void CryptoPP_NV_2_API OS_GenerateRandomBlock(bool blocking, byte *output, size_t size);
...
class CryptoPP_NV_2_DLL AutoSeededRandomPool : public RandomPool
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "AutoSeededRandomPool"; }
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AutoSeededX917RNG<AES>;
...
///   If CryptoPP_NV_2_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined, then DefaultAutoSeededRNG is
