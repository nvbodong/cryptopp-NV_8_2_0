...
#ifndef CryptoPP_NV_2_CRC32_H
#define CryptoPP_NV_2_CRC32_H
...
public:
    ...
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "CRC32";}
...
public:
	...
	void TruncatedFinal(byte *hash, size_t size);
	unsigned int DigestSize() const {return DIGESTSIZE;}
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "CRC32C";}
    std::string AlgorithmName() const {return StaticAlgorithmName();}
