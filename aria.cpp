...
# define CryptoPP_NV_2_ENABLE_ARIA_SSE2_INTRINSICS 1
#endif

#if CryptoPP_NV_2_SSSE3_AVAILABLE
# define CryptoPP_NV_2_ENABLE_ARIA_SSSE3_INTRINSICS 1
#endif
...
using CryptoPP_NV_2::ARIATab::S1;
using CryptoPP_NV_2::ARIATab::S2;
using CryptoPP_NV_2::ARIATab::X1;
using CryptoPP_NV_2::ARIATab::X2;
using CryptoPP_NV_2::ARIATab::KRK;
...
void ARIA::Base::UncheckedSetKey(const byte *key, unsigned int keylen, const NameValuePairs &params)
{
	...
	// Silence warnings
	CryptoPP_NV_2_UNUSED(Q); CryptoPP_NV_2_UNUSED(R);
	CryptoPP_NV_2_UNUSED(q); CryptoPP_NV_2_UNUSED(r);
}
...
#if CryptoPP_NV_2_ENABLE_ARIA_SSSE3_INTRINSICS
	if (HasSSSE3())
	{
...
#endif  // CryptoPP_NV_2_ENABLE_ARIA_SSSE3_INTRINSICS
#if (CryptoPP_NV_2_ARM_NEON_AVAILABLE)
	if (HasNEON())
	{
...
#endif  // CryptoPP_NV_2_LITTLE_ENDIAN
