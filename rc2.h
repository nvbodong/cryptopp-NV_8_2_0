...
#ifndef CryptoPP_NV_2_RC2_H
#define CryptoPP_NV_2_RC2_H
...
{
	CryptoPP_NV_2_CONSTANT(DEFAULT_EFFECTIVE_KEYLENGTH = 1024)
	CryptoPP_NV_2_CONSTANT(MAX_EFFECTIVE_KEYLENGTH = 1024)
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RC2";}
};

/// \brief RC2 block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/RC2">RC2</a> on the Crypto Lounge.
/// \since Crypto++ 3.0
class RC2 : public RC2_Info, public BlockCipherDocumentation
{
	...
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<RC2_Info>
	{
	public:
