...
// Simply disable CryptoPP_NV_2_WIN32_AVAILABLE for Windows Phone and Windows Store apps
#ifdef CryptoPP_NV_2_WIN32_AVAILABLE
# if defined(WINAPI_FAMILY)
#   if !(WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP))
#	  undef CryptoPP_NV_2_WIN32_AVAILABLE
#   endif
# endif
#endif
...
static const byte s_moduleMac[CryptoPP_NV_2::HMAC<CryptoPP_NV_2::SHA1>::DIGESTSIZE] = CryptoPP_NV_2_DUMMY_DLL_MAC;
CryptoPP_NV_2_COMPILE_ASSERT(sizeof(s_moduleMac) == CryptoPP_NV_2::SHA1::DIGESTSIZE);

#ifdef CryptoPP_NV_2_WIN32_AVAILABLE
static HMODULE s_hModule = NULLPTR;
#endif

const byte * CryptoPP_NV_2_API GetActualMacAndLocation(unsigned int &macSize, unsigned int &fileLocation)
{
...
{
	CryptoPP_NV_2::DoPowerUpSelfTest(NULLPTR, s_moduleMac);
}
...
#endif	// #ifdef CryptoPP_NV_2_WIN32_AVAILABLE
                      ...
                      LPVOID /*lpReserved*/)
{
	...
	{
		CryptoPP_NV_2::s_hModule = (HMODULE)hModule;
		CryptoPP_NV_2::DoDllPowerUpSelfTest();
	}
    return TRUE;
}
...
#endif	// #ifndef CryptoPP_NV_2_IMPORTS
