...
#ifndef CryptoPP_NV_2_GFPCRYPT_H
#define CryptoPP_NV_2_GFPCRYPT_H
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_GroupParameters<Integer>;

/// \brief Integer-based GroupParameters specialization
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE DL_GroupParameters_IntegerBased : public ASN1CryptoMaterial<DL_GroupParameters<Integer> >
{
...
public:
    ...
    // Cygwin i386 crash at -O3; see http://github.com/weidai11/CryptoPP_NV_2/issues/40.
    ...
    static std::string CryptoPP_NV_2_API StaticAlgorithmNamePrefix() {return "";}
...
class CryptoPP_NV_2_NO_VTABLE DL_GroupParameters_IntegerBasedImpl : public DL_GroupParametersImpl<GROUP_PRECOMP, BASE_PRECOMP, DL_GroupParameters_IntegerBased>
{
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_GroupParameters_IntegerBasedImpl<ModExpPrecomputation>;

/// \brief GF(p) group parameters
class CryptoPP_NV_2_DLL DL_GroupParameters_GFP : public DL_GroupParameters_IntegerBasedImpl<ModExpPrecomputation>
{
public:
...
class CryptoPP_NV_2_DLL DL_GroupParameters_GFP_DefaultSafePrime : public DL_GroupParameters_GFP
{
public:
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "DSA-1363";}
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "DSA-RFC6979";}
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "GDSA-ISO15946";}
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<Integer>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA1>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA224>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA256>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA384>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA512>;
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "NR";}
...
/// \sa DL_Keys_DSA
class CryptoPP_NV_2_DLL DL_GroupParameters_DSA : public DL_GroupParameters_GFP
{
public:
    ...
    static bool CryptoPP_NV_2_API IsValidPrimeLength(unsigned int pbits)
...
///   <a href="https://www.CryptoPP_NV_2.com/wiki/Digital_Signature_Algorithm">Digital Signature Algorithm</a> on the wiki, and
///   <a href="https://www.CryptoPP_NV_2.com/wiki/NameValuePairs">NameValuePairs</a> on the wiki.
...
{
public:
    static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return "DSA/" + (std::string)H::StaticAlgorithmName();}
};
...
struct DSA_RFC6979 : public DL_SS<
    ...
    DSA_RFC6979<H> >
{
    static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return std::string("DSA-RFC6979/") + H::StaticAlgorithmName();}
};

/// DSA with SHA-1, typedef'd for backwards compatibility
typedef DSA2<SHA1> DSA;

CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PublicKey_GFP<DL_GroupParameters_DSA>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_GFP<DL_GroupParameters_DSA>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_GFP<DL_GroupParameters_DSA>, DSA2<SHA1> >;
...
struct DLIES
    : public DL_ES<
        ...
        DLIES<> >
{
    static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return "DLIES";}    // TODO: fix this after name is standardized
};
