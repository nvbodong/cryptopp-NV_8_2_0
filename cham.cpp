...
{
    CryptoPP_NV_2_CONSTANT(IDX0 = (RR+0) % 4)
    CryptoPP_NV_2_CONSTANT(IDX1 = (RR+1) % 4)
    CryptoPP_NV_2_CONSTANT(IDX3 = (RR+3+1) % 4)
    CryptoPP_NV_2_CONSTANT(R1 = (RR % 2 == 0) ? 1 : 8)
    CryptoPP_NV_2_CONSTANT(R2 = (RR % 2 == 0) ? 8 : 1)
...
inline void CHAM_DecRound(T x[4], const T k[KW], unsigned int i)
{
    ...
    CryptoPP_NV_2_CONSTANT(IDX1 = (RR+1) % 4)
    CryptoPP_NV_2_CONSTANT(IDX3 = (RR+3+1) % 4)
    CryptoPP_NV_2_CONSTANT(R1 = (RR % 2 == 0) ? 8 : 1)
    CryptoPP_NV_2_CONSTANT(R2 = (RR % 2 == 0) ? 1 : 8)
...
#endif  // CryptoPP_NV_2_CHAM_ADVANCED_PROCESS_BLOCKS
