...
#ifndef CryptoPP_NV_2_ESIGN_H
#define CryptoPP_NV_2_ESIGN_H
...
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "EMSA5";}
...
struct ESIGN_Keys
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ESIGN";}
