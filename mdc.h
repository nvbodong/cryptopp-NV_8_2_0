...
#ifndef CryptoPP_NV_2_MDC_H
#define CryptoPP_NV_2_MDC_H
...
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/MDC">MDC</a>
template <class H>
class MDC : public MDC_Info<H>
{
	/// \brief MDC cipher encryption operation
	class CryptoPP_NV_2_NO_VTABLE Enc : public BlockCipherImpl<MDC_Info<H> >
	{
