...
#ifndef CryptoPP_NV_2_CHANNELS_H
#define CryptoPP_NV_2_CHANNELS_H
...
class CryptoPP_NV_2_DLL ChannelSwitch : public Multichannel<Sink>, public ChannelSwitchTypedefs
{
public:
