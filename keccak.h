...
#ifndef CryptoPP_NV_2_KECCAK_H
#define CryptoPP_NV_2_KECCAK_H
...
///   {
///     public:
///       CryptoPP_NV_2_CONSTANT(DIGESTSIZE = 24)
...
{
public:
    CryptoPP_NV_2_CONSTANT(DIGESTSIZE = T_DigestSize)
    CryptoPP_NV_2_CONSTANT(BLOCKSIZE = 200 - 2 * DIGESTSIZE)
...
private:
    ...
    CryptoPP_NV_2_COMPILE_ASSERT(BLOCKSIZE < 200);
    // this is a general expectation by HMAC
    CryptoPP_NV_2_COMPILE_ASSERT((int)BLOCKSIZE > (int)DIGESTSIZE);
#endif
};
