...
///   <A HREF="https://www.CryptoPP_NV_2.com/wiki/Rabbit">Crypto++ Wiki | Rabbit</A>.
/// \since Crypto++ 8.0

#ifndef CryptoPP_NV_2_RABBIT_H
#define CryptoPP_NV_2_RABBIT_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "Rabbit"; }
};
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RabbitWithIV"; }
};
