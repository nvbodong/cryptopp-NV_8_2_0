...
#ifndef CryptoPP_NV_2_RW_H
#define CryptoPP_NV_2_RW_H
...
class CryptoPP_NV_2_DLL RWFunction : public TrapdoorFunction, public PublicKey
{
...
/// \since Crypto++ 3.0, Tweaked roots using <em>e</em> and <em>f</em> since Crypto++ 5.6.4
class CryptoPP_NV_2_DLL InvertibleRWFunction : public RWFunction, public TrapdoorFunctionInverse, public PrivateKey
{
...
public:
	...
	virtual void Precompute(unsigned int unused = 0) {CryptoPP_NV_2_UNUSED(unused); PrecomputeTweakedRoots();}
	virtual void Precompute(unsigned int unused = 0) const {CryptoPP_NV_2_UNUSED(unused); PrecomputeTweakedRoots();}
...
struct RW
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RW";}
