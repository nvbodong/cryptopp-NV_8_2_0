...
#ifndef CryptoPP_NV_2_FILES_H
#define CryptoPP_NV_2_FILES_H
...
class CryptoPP_NV_2_DLL FileStore : public Store, private FilterPutSpaceHelper, public NotCopyable
{
public:
...
#if defined(CryptoPP_NV_2_UNIX_AVAILABLE) || defined(CryptoPP_NV_2_DOXYGEN_PROCESSING) || _MSC_VER >= 1400
	/// \brief Construct a FileStore
...
/// \brief Implementation of Store interface
/// \details file-based implementation of Store interface
class CryptoPP_NV_2_DLL FileSource : public SourceTemplate<FileStore>
{
public:
...
class CryptoPP_NV_2_DLL FileSink : public Sink, public NotCopyable
{
public:
	/// \brief Exception thrown when file-based error is encountered
	class Err : public Exception
...
#if defined(CryptoPP_NV_2_UNIX_AVAILABLE) || _MSC_VER >= 1400
	/// \brief Construct a FileSink
	/// \param filename the Unicode name of the file to open
	/// \details On non-Windows OS, this function assumes that setlocale() has been called.
