...
#ifndef CryptoPP_NV_2_CHAM_H
#define CryptoPP_NV_2_CHAM_H
...
# define CryptoPP_NV_2_CHAM_ADVANCED_PROCESS_BLOCKS 1
#endif

// Yet another SunStudio/SunCC workaround. Failed self tests
// in SSE code paths on i386 for SunStudio 12.3 and below.
#if defined(__SUNPRO_CC) && (__SUNPRO_CC <= 0x5120)
# undef CryptoPP_NV_2_CHAM_ADVANCED_PROCESS_BLOCKS
#endif
...
/// \sa CHAM128, <a href="http://www.CryptoPP_NV_2.com/wiki/CHAM">CHAM</a>,
...
/// \since Crypto++ 8.0
class CryptoPP_NV_2_NO_VTABLE CHAM64 : public CHAM64_Info, public BlockCipherDocumentation
{
public:
    /// \brief CHAM block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<CHAM64_Info>
    {
    protected:
...
#if CryptoPP_NV_2_CHAM_ADVANCED_PROCESS_BLOCKS
...
/// \note Crypto++ provides a byte oriented implementation
/// \sa CHAM64, <a href="http://www.CryptoPP_NV_2.com/wiki/CHAM">CHAM</a>,
///   <a href="https://pdfs.semanticscholar.org/2f57/61b5c2614cffd58a09cc83c375a2b32a2ed3.pdf">
///   CHAM: A Family of Lightweight Block Ciphers for Resource-Constrained Devices</a>
/// \since Crypto++ 8.0
class CryptoPP_NV_2_NO_VTABLE CHAM128 : public CHAM128_Info, public BlockCipherDocumentation
{
public:
    /// \brief CHAM block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<CHAM128_Info>
    {
    protected:
        void UncheckedSetKey(const byte *userKey, unsigned int keyLength, const NameValuePairs &params);
        std::string AlgorithmProvider() const;
