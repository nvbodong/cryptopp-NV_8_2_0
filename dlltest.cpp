...
void FIPS140_SampleApplication()
{
	...
	CryptoPP_NV_2_ASSERT(signer.SignatureLength() == 40);
...
extern "C" __declspec(dllexport) void __cdecl SetNewAndDeleteFromCryptoPP_NV_2(PNew pNew, PDelete pDelete, PSetNewHandler pSetNewHandler)
{
	(void)(pSetNewHandler);
	s_pNew = pNew;
	s_pDelete = pDelete;
