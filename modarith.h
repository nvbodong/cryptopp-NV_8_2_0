...
#ifndef CryptoPP_NV_2_MODARITH_H
#define CryptoPP_NV_2_MODARITH_H
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AbstractGroup<Integer>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AbstractRing<Integer>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AbstractEuclideanDomain<Integer>;
...
class CryptoPP_NV_2_DLL ModularArithmetic : public AbstractRing<Integer>
{
public:
	...
	{
		CryptoPP_NV_2_UNUSED(ignore_for_now);
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
class CryptoPP_NV_2_DLL MontgomeryRepresentation : public ModularArithmetic
{
public:
