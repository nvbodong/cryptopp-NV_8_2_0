...
#if defined(CryptoPP_NV_2_CURVE25519_64BIT)
...
using CryptoPP_NV_2::sword32;
using CryptoPP_NV_2::word64;
using CryptoPP_NV_2::sword64;

using CryptoPP_NV_2::GetBlock;
using CryptoPP_NV_2::LittleEndian;

// Bring in all the symbols from the 64-bit header
using namespace CryptoPP_NV_2::Donna::Arch64;
...
{
    using namespace CryptoPP_NV_2::Donna::X25519;
...
#if (CryptoPP_NV_2_CURVE25519_SSE2)
    if (HasSSE2())
...
{
    using namespace CryptoPP_NV_2::Donna::Ed25519;
...
#endif  // CryptoPP_NV_2_CURVE25519_64BIT
