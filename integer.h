...
#ifndef CryptoPP_NV_2_INTEGER_H
#define CryptoPP_NV_2_INTEGER_H
...
// Always align, http://github.com/weidai11/CryptoPP_NV_2/issues/256
...
/// \since Crypto++ 1.0
/// \nosubgrouping
class CryptoPP_NV_2_DLL Integer : private InitializeInteger, public ASN1Object
{
public:
	...
	//@{
		...
		static const Integer & CryptoPP_NV_2_API Zero();
		...
		static const Integer & CryptoPP_NV_2_API One();
		...
		static const Integer & CryptoPP_NV_2_API Two();
		...
		static Integer CryptoPP_NV_2_API Power2(size_t e);
	//@}
	...
	//@{
		...
		static void CryptoPP_NV_2_API Divide(Integer &r, Integer &q, const Integer &a, const Integer &d);
		...
		static void CryptoPP_NV_2_API Divide(word &r, Integer &q, const Integer &a, word d);
		...
		static void CryptoPP_NV_2_API DivideByPowerOf2(Integer &r, Integer &q, const Integer &a, unsigned int n);
		...
		static Integer CryptoPP_NV_2_API Gcd(const Integer &a, const Integer &n);
	...
	//@{
		...
		friend CryptoPP_NV_2_DLL std::istream& CryptoPP_NV_2_API operator>>(std::istream& in, Integer &a);
		...
		friend CryptoPP_NV_2_DLL std::ostream& CryptoPP_NV_2_API operator<<(std::ostream& out, const Integer &a);
	//@}
	...
	CryptoPP_NV_2_DLL friend Integer CryptoPP_NV_2_API a_times_b_mod_c(const Integer &x, const Integer& y, const Integer& m);
	/// \brief Modular exponentiation
	/// \param x a reference to the base
	/// \param e a reference to the exponent
	/// \param m a reference to the modulus
	/// \returns an Integer <tt>(a ^ b) % m</tt>.
	CryptoPP_NV_2_DLL friend Integer CryptoPP_NV_2_API a_exp_b_mod_c(const Integer &x, const Integer& e, const Integer& m);
...
/// \brief Comparison
inline bool operator==(const CryptoPP_NV_2::Integer& a, const CryptoPP_NV_2::Integer& b) {return a.Compare(b)==0;}
/// \brief Comparison
inline bool operator!=(const CryptoPP_NV_2::Integer& a, const CryptoPP_NV_2::Integer& b) {return a.Compare(b)!=0;}
/// \brief Comparison
inline bool operator> (const CryptoPP_NV_2::Integer& a, const CryptoPP_NV_2::Integer& b) {return a.Compare(b)> 0;}
...
inline bool operator<=(const CryptoPP_NV_2::Integer& a, const CryptoPP_NV_2::Integer& b) {return a.Compare(b)<=0;}
/// \brief Addition
inline CryptoPP_NV_2::Integer operator+(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.Plus(b);}
/// \brief Subtraction
inline CryptoPP_NV_2::Integer operator-(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.Minus(b);}
/// \brief Multiplication
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline CryptoPP_NV_2::Integer operator*(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.Times(b);}
/// \brief Division
inline CryptoPP_NV_2::Integer operator/(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline CryptoPP_NV_2::Integer operator%(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.Modulo(b);}
/// \brief Division
inline CryptoPP_NV_2::Integer operator/(const CryptoPP_NV_2::Integer &a, CryptoPP_NV_2::word b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline CryptoPP_NV_2::word    operator%(const CryptoPP_NV_2::Integer &a, CryptoPP_NV_2::word b) {return a.Modulo(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline CryptoPP_NV_2::Integer operator&(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.And(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline CryptoPP_NV_2::Integer operator|(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.Or(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline CryptoPP_NV_2::Integer operator^(const CryptoPP_NV_2::Integer &a, const CryptoPP_NV_2::Integer &b) {return a.Xor(b);}

NAMESPACE_END

#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
inline void swap(CryptoPP_NV_2::Integer &a, CryptoPP_NV_2::Integer &b)
{
	a.swap(b);
}
NAMESPACE_END
