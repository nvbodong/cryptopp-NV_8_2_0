...
#ifndef CryptoPP_NV_2_SOSEMANUK_H
#define CryptoPP_NV_2_SOSEMANUK_H
...
# define CryptoPP_NV_2_DISABLE_SOSEMANUK_ASM 1
#endif
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Sosemanuk";}
};
