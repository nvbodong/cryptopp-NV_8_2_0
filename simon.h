...
///   The Simon and Speck GitHub</A> and <A HREF="https://www.CryptoPP_NV_2.com/wiki/SIMON">
///   SIMON</A> on the Crypto++ wiki.
/// \since Crypto++ 6.0

#ifndef CryptoPP_NV_2_SIMON_H
#define CryptoPP_NV_2_SIMON_H
...
#include "secblock.h"
    ...
    CryptoPP_NV_2_BOOL_ARM32 || CryptoPP_NV_2_BOOL_ARMV8 || \
    CryptoPP_NV_2_BOOL_PPC32 || CryptoPP_NV_2_BOOL_PPC64
# ifndef CryptoPP_NV_2_DISABLE_SIMON_SIMD
#  define CryptoPP_NV_2_SIMON64_ADVANCED_PROCESS_BLOCKS 1
# endif
#endif
    ...
    CryptoPP_NV_2_BOOL_PPC32 || CryptoPP_NV_2_BOOL_PPC64
# ifndef CryptoPP_NV_2_DISABLE_SIMON_SIMD
#  define CryptoPP_NV_2_SIMON128_ADVANCED_PROCESS_BLOCKS 1
# endif
#endif
...
# undef CryptoPP_NV_2_SIMON64_ADVANCED_PROCESS_BLOCKS
# undef CryptoPP_NV_2_SIMON128_ADVANCED_PROCESS_BLOCKS
#endif
...
/// \sa SIMON64, SIMON128, <a href="http://www.CryptoPP_NV_2.com/wiki/SIMON">SIMON</a> on the Crypto++ wiki
/// \since Crypto++ 6.0
template <class W>
struct SIMON_Base
{
...
///   The Simon and Speck GitHub</A>, <a href="http://www.CryptoPP_NV_2.com/wiki/SIMON">SIMON</a> on the
///   Crypto++ wiki
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE SIMON64 : public SIMON_Info<8, 12, 12, 16>, public BlockCipherDocumentation
{
public:
    /// \brief SIMON block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : protected SIMON_Base<word32>, public BlockCipherImpl<SIMON_Info<8, 12, 12, 16> >
    {
    public:
        /// \brief The algorithm name
        /// \returns the algorithm name
...
#if CryptoPP_NV_2_SIMON64_ADVANCED_PROCESS_BLOCKS
...
///   Crypto++ wiki
/// \since Crypto++ 6.0
class CryptoPP_NV_2_NO_VTABLE SIMON128 : public SIMON_Info<16, 16, 16, 32>, public BlockCipherDocumentation
{
public:
    /// \brief SIMON block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CryptoPP_NV_2_NO_VTABLE Base : protected SIMON_Base<word64>, public BlockCipherImpl<SIMON_Info<16, 16, 16, 32> >
    {
    public:
        /// \brief The algorithm name
        /// \returns the algorithm name
    ...
    public:
        void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
#if CryptoPP_NV_2_SIMON128_ADVANCED_PROCESS_BLOCKS
        size_t AdvancedProcessBlocks(const byte *inBlocks, const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags) const;
#endif
    };
