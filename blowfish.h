...
#ifndef CryptoPP_NV_2_BLOWFISH_H
#define CryptoPP_NV_2_BLOWFISH_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Blowfish";}
};

// <a href="http://www.CryptoPP_NV_2.com/wiki/Blowfish">Blowfish</a>
...
class Blowfish : public Blowfish_Info, public BlockCipherDocumentation
{
	...
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<Blowfish_Info>
	{
	public:
