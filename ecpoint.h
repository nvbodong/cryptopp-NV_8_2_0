...
#ifndef CryptoPP_NV_2_ECPOINT_H
#define CryptoPP_NV_2_ECPOINT_H
...
/// \since Crypto++ 2.0
struct CryptoPP_NV_2_DLL ECPPoint
{
	virtual ~ECPPoint() {}
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AbstractGroup<ECPPoint>;

/// \brief Elliptical Curve Point over GF(2^n)
/// \since Crypto++ 2.0
struct CryptoPP_NV_2_DLL EC2NPoint
{
	virtual ~EC2NPoint() {}
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AbstractGroup<EC2NPoint>;
