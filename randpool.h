...
#ifndef CryptoPP_NV_2_RANDPOOL_H
#define CryptoPP_NV_2_RANDPOOL_H
...
/// \sa OldRandomPool
/// \since Crypto++ 4.0 (PGP 2.6.x style), Crypto++ 5.5 (AES-256 based)
class CryptoPP_NV_2_DLL RandomPool : public RandomNumberGenerator, public NotCopyable
{
public:
...
///   CryptoPP_NV_2_MAINTAIN_BACKWARDS_COMPATIBILITY. OldRandomPool also provides the modern
...
class CryptoPP_NV_2_DLL OldRandomPool : public RandomNumberGenerator
{
public:
