...
bool RabinFunction::GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const
{
	return GetValueHelper(this, name, valueType, pValue).Assignable()
		...
		CryptoPP_NV_2_GET_FUNCTION_ENTRY(QuadraticResidueModPrime1)
		CryptoPP_NV_2_GET_FUNCTION_ENTRY(QuadraticResidueModPrime2)
		;
}
...
void RabinFunction::AssignFrom(const NameValuePairs &source)
{
	AssignFromHelper(this, source)
		...
		CryptoPP_NV_2_SET_FUNCTION_ENTRY(QuadraticResidueModPrime1)
		CryptoPP_NV_2_SET_FUNCTION_ENTRY(QuadraticResidueModPrime2)
		;
}
