...
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/SIMECK">SIMECK</a>,
///   <a href="https://eprint.iacr.org/2015/612.pdf">The Simeck
///   Family of Lightweight Block Ciphers</a>
/// \since Crypto++ 8.0

#ifndef CryptoPP_NV_2_SIMECK_H
#define CryptoPP_NV_2_SIMECK_H
...
# define CryptoPP_NV_2_SIMECK_ADVANCED_PROCESS_BLOCKS 1
#endif

// Yet another SunStudio/SunCC workaround. Failed self tests
// in SSE code paths on i386 for SunStudio 12.3 and below.
#if defined(__SUNPRO_CC) && (__SUNPRO_CC <= 0x5120)
# undef CryptoPP_NV_2_SIMECK_ADVANCED_PROCESS_BLOCKS
#endif
...
/// \sa SIMECK64, <a href="http://www.CryptoPP_NV_2.com/wiki/SIMECK">SIMECK</a>,
///   <a href="https://eprint.iacr.org/2015/612.pdf">The Simeck Family of
///   Lightweight Block Ciphers</a>
/// \since Crypto++ 8.0
class CryptoPP_NV_2_NO_VTABLE SIMECK32 : public SIMECK32_Info, public BlockCipherDocumentation
{
public:
    /// \brief SIMECK block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SIMECK32_Info>
    {
    protected:
...
/// \note Crypto++ provides a byte oriented implementation
/// \sa SIMECK32, <a href="http://www.CryptoPP_NV_2.com/wiki/SIMECK">SIMECK</a>,
///   <a href= "https://eprint.iacr.org/2015/612.pdf">The Simeck Family of
///   Lightweight Block Ciphers</a>
/// \since Crypto++ 8.0
class CryptoPP_NV_2_NO_VTABLE SIMECK64 : public SIMECK64_Info, public BlockCipherDocumentation
{
public:
    /// \brief SIMECK block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SIMECK64_Info>
    {
    protected:
        void UncheckedSetKey(const byte *userKey, unsigned int keyLength, const NameValuePairs &params);
        std::string AlgorithmProvider() const;
...
#if CryptoPP_NV_2_SIMECK_ADVANCED_PROCESS_BLOCKS
