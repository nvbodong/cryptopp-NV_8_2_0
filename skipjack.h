...
///  href="http://www.CryptoPP_NV_2.com/wiki/SKIPJACK">SKIPJACK</a> on the Crypto++ wiki

#ifndef CryptoPP_NV_2_SKIPJACK_H
#define CryptoPP_NV_2_SKIPJACK_H
...
{
	CryptoPP_NV_2_DLL static const char * CryptoPP_NV_2_API StaticAlgorithmName() {return "SKIPJACK";}
};
...
class SKIPJACK : public SKIPJACK_Info, public BlockCipherDocumentation
{
	...
	class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SKIPJACK_Info>
	{
	public:
