...
# if !defined(CryptoPP_NV_2_NO_CPU_FEATURE_PROBES) && !CryptoPP_NV_2_SSE2_ASM_AVAILABLE && CryptoPP_NV_2_SSE2_INTRIN_AVAILABLE
#  include <emmintrin.h>
# endif
#endif
...
#if CryptoPP_NV_2_BOOL_X64 || defined(__APPLE__)
    return true;
#elif defined(CryptoPP_NV_2_NO_CPU_FEATURE_PROBES)
    return false;
#elif defined(CryptoPP_NV_2_MS_STYLE_INLINE_ASSEMBLY)
    __try
    {
# if CryptoPP_NV_2_SSE2_ASM_AVAILABLE
        AS2(por xmm0, xmm0)        // executing SSE2 instruction
# elif CryptoPP_NV_2_SSE2_INTRIN_AVAILABLE
