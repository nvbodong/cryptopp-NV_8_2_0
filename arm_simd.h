...
#ifndef CryptoPP_NV_2_ARM_SIMD_H
#define CryptoPP_NV_2_ARM_SIMD_H
...
#if (CryptoPP_NV_2_ARM_PMULL_AVAILABLE) || defined(CryptoPP_NV_2_DOXYGEN_PROCESSING)
...
{
    // https://github.com/weidai11/CryptoPP_NV_2/issues/366
#if defined(_MSC_VER)
    return (uint64x2_t)vextq_u8(
        vreinterpretq_u8_u64(a), vreinterpretq_u8_u64(b), C);
#else
...
#endif // CryptoPP_NV_2_ARM_SIMD_H
