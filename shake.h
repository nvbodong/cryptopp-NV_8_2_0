...
#ifndef CryptoPP_NV_2_SHAKE_H
#define CryptoPP_NV_2_SHAKE_H
...
{
public:
    CryptoPP_NV_2_CONSTANT(DIGESTSIZE = (T_Strength == 128 ? 32 : 64))
    CryptoPP_NV_2_CONSTANT(BLOCKSIZE = (T_Strength == 128 ? 1344/8 : 1088/8))
