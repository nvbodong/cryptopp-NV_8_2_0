...
#ifndef CryptoPP_NV_2_BASECODE_H
#define CryptoPP_NV_2_BASECODE_H
...
class CryptoPP_NV_2_DLL BaseN_Encoder : public Unflushable<Filter>
{
public:
...
class CryptoPP_NV_2_DLL BaseN_Decoder : public Unflushable<Filter>
{
public:
	...
	static void CryptoPP_NV_2_API InitializeDecodingLookupArray(int *lookup, const byte *alphabet, unsigned int base, bool caseInsensitive);
...
class CryptoPP_NV_2_DLL Grouper : public Bufferless<Filter>
{
public:
