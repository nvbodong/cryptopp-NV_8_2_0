...
#ifndef CryptoPP_NV_2_HC256_H
#define CryptoPP_NV_2_HC256_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "HC-256"; }
};
