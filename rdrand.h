...
#ifndef CryptoPP_NV_2_RDRAND_H
#define CryptoPP_NV_2_RDRAND_H

#include "cryptlib.h"

// This class file provides both RDRAND and RDSEED. They were added at
//   Crypto++ 5.6.3. At compile time, it uses CryptoPP_NV_2_BOOL_{X86|X32|X64}
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RDRAND"; }
...
{
public:
    CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RDSEED"; }
