...
{
	CryptoPP_NV_2_UNUSED(params); CryptoPP_NV_2_UNUSED(key); CryptoPP_NV_2_UNUSED(length);
	word32 k0, k1, k2, k3;
...
#define WAKE_OUTPUT(x)\
	...
	{\
		CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 0, r6);\
		r3 = M(r3, r6);\
		r4 = M(r4, r3);\
		r5 = M(r5, r4);\
		r6 = M(r6, r5);\
	...
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_SWITCH(WAKE_OUTPUT, 0);
}
/*
template <class B>
