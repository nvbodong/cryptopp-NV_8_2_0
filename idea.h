...
#ifndef CryptoPP_NV_2_IDEA_H
#define CryptoPP_NV_2_IDEA_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "IDEA";}
};

/// \brief IDEA block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/IDEA">IDEA</a>
/// \since Crypto++ 1.0
...
private:
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<IDEA_Info>
	{
	public:
