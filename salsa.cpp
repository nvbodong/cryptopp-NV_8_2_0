...
// use "cl /EP /P /DCryptoPP_NV_2_GENERATE_X64_MASM salsa.cpp" to generate MASM code
...
#if defined(CryptoPP_NV_2_DISABLE_SALSA_ASM)
...
{
	CryptoPP_NV_2_ASSERT(data != NULLPTR);
	CryptoPP_NV_2_ASSERT(rounds % 2 == 0);

	CryptoPP_NV_2_ALIGN_DATA(16) word32 x[16];
...
{
#if CryptoPP_NV_2_SSE2_ASM_AVAILABLE && !defined(CryptoPP_NV_2_DISABLE_SALSA_ASM)
	if (HasSSE2())
		return "SSE2";
#endif
	return "C++";
...
{
	CryptoPP_NV_2_UNUSED(keystreamBuffer), CryptoPP_NV_2_UNUSED(length);
	CryptoPP_NV_2_ASSERT(length==8);
...
{
#if CryptoPP_NV_2_SSE2_ASM_AVAILABLE
	if (HasSSE2())
		return 16;
	else
#endif
...
{
#endif	// #ifdef CryptoPP_NV_2_GENERATE_X64_MASM
	...
	if (HasSSE2())
	{
		...
		CryptoPP_NV_2_ALIGN_DATA(16) byte workspace[16*32];
	#else
...
#ifndef CryptoPP_NV_2_GENERATE_X64_MASM
	{
		...
		while (iterationCount--)
		{
			...
			#define SALSA_OUTPUT(x)	{\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 0, x0 + m_state[0]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 1, x13 + m_state[13]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 2, x10 + m_state[10]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 3, x7 + m_state[7]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 4, x4 + m_state[4]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 5, x1 + m_state[1]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 6, x14 + m_state[14]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 7, x11 + m_state[11]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 8, x8 + m_state[8]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 9, x5 + m_state[5]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 10, x2 + m_state[2]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 11, x15 + m_state[15]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 12, x12 + m_state[12]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 13, x9 + m_state[9]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 14, x6 + m_state[6]);\
				CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 15, x3 + m_state[3]);}

			CryptoPP_NV_2_KEYSTREAM_OUTPUT_SWITCH(SALSA_OUTPUT, BYTES_PER_ITERATION);
			#undef SALSA_OUTPUT
#endif
...
{
	CryptoPP_NV_2_UNUSED(keystreamBuffer), CryptoPP_NV_2_UNUSED(length);
	CryptoPP_NV_2_ASSERT(length==24);
