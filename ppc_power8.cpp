...
bool CPU_ProbePower8()
{
    ...
    return false;
#elif (_ARCH_PWR8) && defined(CryptoPP_NV_2_POWER8_AVAILABLE)
...
#if defined(CryptoPP_NV_2_NO_CPU_FEATURE_PROBES)
    return false;
#elif (__CRYPTO__) && defined(CryptoPP_NV_2_POWER8_AES_AVAILABLE)
# if defined(CryptoPP_NV_2_GNU_STYLE_INLINE_ASSEMBLY)
...
#if defined(CryptoPP_NV_2_NO_CPU_FEATURE_PROBES)
    return false;
#elif (__CRYPTO__) && defined(CryptoPP_NV_2_POWER8_SHA_AVAILABLE)
# if defined(CryptoPP_NV_2_GNU_STYLE_INLINE_ASSEMBLY)
