...
{
	CryptoPP_NV_2_ASSERT(input);	CryptoPP_NV_2_ASSERT(output);
	CryptoPP_NV_2_ASSERT(m_cipher->IsForwardTransformation());
	CryptoPP_NV_2_ASSERT(m_register.size() == BlockSize());
	CryptoPP_NV_2_ASSERT(m_temp.size() == BlockSize());
	CryptoPP_NV_2_ASSERT(iterationCount > 0);
...
{
	CryptoPP_NV_2_ASSERT(length == BlockSize());
	CryptoPP_NV_2_ASSERT(m_register.size() == BlockSize());
...
{
	CryptoPP_NV_2_ASSERT(!m_register.empty());
	CryptoPP_NV_2_ASSERT(BlockSize() >= m_feedbackSize);
...
{
	CryptoPP_NV_2_ASSERT(m_cipher->IsForwardTransformation());
	CryptoPP_NV_2_ASSERT(m_counterArray.size() == BlockSize());
...
{
	CryptoPP_NV_2_UNUSED(outLength);
