...
#ifndef CryptoPP_NV_2_LUBYRACK_H
#define CryptoPP_NV_2_LUBYRACK_H
...
{
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<LR_Info<T> >
	{
	public:
	...
	protected:
		CryptoPP_NV_2_CONSTANT(S=T::DIGESTSIZE)
