...
using CryptoPP_NV_2::vec_swap;  // SunCC
...
using CryptoPP_NV_2::VecAnd;
using CryptoPP_NV_2::VecXor;
using CryptoPP_NV_2::VecLoad;
using CryptoPP_NV_2::VecLoadBE;
using CryptoPP_NV_2::VecPermute;
...
#endif  // CryptoPP_NV_2_ALTIVEC_AVAILABLE
