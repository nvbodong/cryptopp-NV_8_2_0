...
#ifndef CryptoPP_NV_2_RIPEMD_H
#define CryptoPP_NV_2_RIPEMD_H
...
public:
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-160";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-320";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-128";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-256";}
};
