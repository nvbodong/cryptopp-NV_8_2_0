...
#ifndef CryptoPP_NV_2_SEAL_H
#define CryptoPP_NV_2_SEAL_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == LITTLE_ENDIAN_ORDER ? "SEAL-3.0-LE" : "SEAL-3.0-BE";}
};
...
/// \since Crypto++ 2.2
template <class B = BigEndian>
class CryptoPP_NV_2_NO_VTABLE SEAL_Policy : public AdditiveCipherConcretePolicy<word32, 256>, public SEAL_Info<B>
{
protected:
...
/// \tparam B Endianness of the stream cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/SEAL-3.0-BE">SEAL</a>
/// \since Crypto++ 2.2
template <class B = BigEndian>
