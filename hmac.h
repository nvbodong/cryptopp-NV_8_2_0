...
#ifndef CryptoPP_NV_2_HMAC_H
#define CryptoPP_NV_2_HMAC_H
...
/// \since Crypto++ 2.1
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE HMAC_Base : public VariableKeyLength<16, 0, INT_MAX>, public MessageAuthenticationCode
{
public:
	virtual ~HMAC_Base() {}
...
{
public:
	CryptoPP_NV_2_CONSTANT(DIGESTSIZE=T::DIGESTSIZE)
