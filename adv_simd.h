...
#ifndef CryptoPP_NV_2_ADVANCED_SIMD_TEMPLATES
#define CryptoPP_NV_2_ADVANCED_SIMD_TEMPLATES
...
// SunCC needs CryptoPP_NV_2_SSSE3_AVAILABLE, too
...
using CryptoPP_NV_2::BlockTransformation;

CryptoPP_NV_2_CONSTANT(BT_XorInput = BlockTransformation::BT_XorInput)
CryptoPP_NV_2_CONSTANT(BT_AllowParallel = BlockTransformation::BT_AllowParallel)
CryptoPP_NV_2_CONSTANT(BT_InBlockIsCounter = BlockTransformation::BT_InBlockIsCounter)
CryptoPP_NV_2_CONSTANT(BT_ReverseDirection = BlockTransformation::BT_ReverseDirection)
CryptoPP_NV_2_CONSTANT(BT_DontIncrementInOutPointers = BlockTransformation::BT_DontIncrementInOutPointers)
            ...
            const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags)
{
    ...
    CryptoPP_NV_2_ASSERT(inBlocks);
    CryptoPP_NV_2_ASSERT(outBlocks);
    CryptoPP_NV_2_ASSERT(length >= 16);
...
// Hack for SunCC, http://github.com/weidai11/CryptoPP_NV_2/issues/224
...
#endif  // CryptoPP_NV_2_SSSE3_AVAILABLE
        ...
        const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags)
{
    ...
    CryptoPP_NV_2_ALIGN_DATA(16) uint8_t temp[16];
...
#endif  // CryptoPP_NV_2_ADVANCED_SIMD_TEMPLATES
