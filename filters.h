...
#ifndef CryptoPP_NV_2_FILTERS_H
#define CryptoPP_NV_2_FILTERS_H
...
///   more details.
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Filter : public BufferedTransformation, public NotCopyable
{
public:
	virtual ~Filter() {}
...
struct CryptoPP_NV_2_DLL FilterPutSpaceHelper
{
	...
	{
		CryptoPP_NV_2_ASSERT(desiredSize >= minSize && bufferSize >= minSize);
...
class CryptoPP_NV_2_DLL MeterFilter : public Bufferless<Filter>
{
public:
	virtual ~MeterFilter() {}
	...
	void IsolatedInitialize(const NameValuePairs &parameters)
		{CryptoPP_NV_2_UNUSED(parameters); ResetMeter();}
...
class CryptoPP_NV_2_DLL TransparentFilter : public MeterFilter
{
public:
...
class CryptoPP_NV_2_DLL OpaqueFilter : public MeterFilter
{
public:
...
class CryptoPP_NV_2_DLL FilterWithBufferedInput : public Filter
{
public:
...
protected:
	...
	virtual void InitializeDerivedAndReturnNewSizes(const NameValuePairs &parameters, size_t &firstSize, size_t &blockSize, size_t &lastSize)
		{CryptoPP_NV_2_UNUSED(parameters); CryptoPP_NV_2_UNUSED(firstSize); CryptoPP_NV_2_UNUSED(blockSize); CryptoPP_NV_2_UNUSED(lastSize); InitializeDerived(parameters);}
	...
	virtual void NextPutSingle(const byte *inString)
		{CryptoPP_NV_2_UNUSED(inString); CryptoPP_NV_2_ASSERT(false);}
...
protected:
	...
	virtual int NextPut(const byte *inString, size_t length)
		{CryptoPP_NV_2_UNUSED(inString); CryptoPP_NV_2_UNUSED(length); CryptoPP_NV_2_ASSERT(false); return 0;}
...
class CryptoPP_NV_2_DLL FilterWithInputQueue : public Filter
{
public:
...
protected:
	...
	void IsolatedInitialize(const NameValuePairs &parameters)
		{CryptoPP_NV_2_UNUSED(parameters); m_inQueue.Clear();}
...
/// \since Crypto++ 5.0
class CryptoPP_NV_2_DLL StreamTransformationFilter : public FilterWithBufferedInput, public BlockPaddingSchemeDef, private FilterPutSpaceHelper
{
public:
...
/// \since Crypto++ 1.0
class CryptoPP_NV_2_DLL HashFilter : public Bufferless<Filter>, private FilterPutSpaceHelper
{
public:
	virtual ~HashFilter() {}
...
/// \brief Filter wrapper for HashTransformation
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL HashVerificationFilter : public FilterWithBufferedInput
{
public:
...
/// \since Crypto++ 5.6.0
class CryptoPP_NV_2_DLL AuthenticatedEncryptionFilter : public StreamTransformationFilter
{
public:
...
/// \since Crypto++ 5.6.0
class CryptoPP_NV_2_DLL AuthenticatedDecryptionFilter : public FilterWithBufferedInput, public BlockPaddingSchemeDef
{
public:
	/// \enum Flags
	/// \brief Flags controlling filter behavior.
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL SignerFilter : public Unflushable<Filter>
{
public:
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL SignatureVerificationFilter : public FilterWithBufferedInput
{
public:
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL Redirector : public CustomSignalPropagation<Sink>
{
public:
	/// \enum Behavior
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL OutputProxy : public CustomSignalPropagation<Sink>
{
public:
	virtual ~OutputProxy() {}
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL ProxyFilter : public FilterWithBufferedInput
{
public:
	virtual ~ProxyFilter() {}
...
/// \since Crypto++ 5.0
class CryptoPP_NV_2_DLL SimpleProxyFilter : public ProxyFilter
{
public:
	...
	/// </pre>
	void LastPut(const byte *inString, size_t length)
		{CryptoPP_NV_2_UNUSED(inString), CryptoPP_NV_2_UNUSED(length); m_filter->MessageEnd();}
};
...
/// \since Crypto++ 5.0
class CryptoPP_NV_2_DLL PK_EncryptorFilter : public SimpleProxyFilter
{
public:
...
/// \since Crypto++ 5.0
class CryptoPP_NV_2_DLL PK_DecryptorFilter : public SimpleProxyFilter
{
public:
...
public:
	...
	StringSinkTemplate(T &output)
		: m_output(&output) {CryptoPP_NV_2_ASSERT(sizeof(value_type)==1);}
	...
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
	{
		CryptoPP_NV_2_UNUSED(messageEnd); CryptoPP_NV_2_UNUSED(blocking);
		if (length > 0)
		{
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS StringSinkTemplate<std::string>;
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS StringSinkTemplate<std::vector<byte> >;
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL ArraySink : public Bufferless<Sink>
{
public:
	virtual ~ArraySink() {}
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL ArrayXorSink : public ArraySink
{
public:
...
public:
	...
	CryptoPP_NV_2_DLL size_t TransferTo2(BufferedTransformation &target, lword &transferBytes, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true);
	CryptoPP_NV_2_DLL size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const;

private:
	CryptoPP_NV_2_DLL void StoreInitialize(const NameValuePairs &parameters);
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL RandomNumberStore : public Store
{
public:
	...
	size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const
	{
		CryptoPP_NV_2_UNUSED(target); CryptoPP_NV_2_UNUSED(begin); CryptoPP_NV_2_UNUSED(end); CryptoPP_NV_2_UNUSED(channel); CryptoPP_NV_2_UNUSED(blocking);
...
/// \brief Empty store
/// \since Crypto++ 5.0
class CryptoPP_NV_2_DLL NullStore : public Store
{
public:
...
/// \since Crypto++ 1.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Source : public InputRejecting<Filter>
{
public:
	virtual ~Source() {}
...
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL StringSource : public SourceTemplate<StringStore>
{
public:
...
/// \since Crypto++ 8.0
class CryptoPP_NV_2_DLL VectorSource : public SourceTemplate<StringStore>
{
public:
...
/// \brief RNG-based implementation of Source interface
/// \since Crypto++ 4.0
class CryptoPP_NV_2_DLL RandomNumberSource : public SourceTemplate<RandomNumberStore>
{
public:
