...
http://www.CryptoPP_NV_2.com the most up to date build instructions and porting notes.
...
your .exe file. dll.h includes the line #pragma comment(lib, "CryptoPP_NV_2")
...
into the process space for exported functions "GetNewAndDeleteForCryptoPP_NV_2"
and "SetNewAndDeleteFromCryptoPP_NV_2". If one of these functions is found,
...
two files, libCryptoPP_NV_2.a and cryptest.exe. Run "cryptest.exe v" for the
...
define CryptoPP_NV_2_INIT_PRIORITY to control object initialization order. Set it to a
value like 250. User programs can use CryptoPP_NV_2_USER_PRIORITY to avoid conflicts with
...
a link to the manual from http://www.CryptoPP_NV_2.com. Also at that site is
...
8.1.0 - February 22, 2019
      ...
      - add CryptoPP_NV_2_BUGGY_SIMD_LOAD_AND_STORE
...
8.0.0 - December 28, 2018
      ...
      - remove CryptoPP_NV_2_ALLOW_UNALIGNED_DATA_ACCESS support
