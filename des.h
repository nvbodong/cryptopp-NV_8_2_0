...
#ifndef CryptoPP_NV_2_DES_H
#define CryptoPP_NV_2_DES_H
...
/// \since Crypto++ 1.0
class CryptoPP_NV_2_DLL RawDES
{
public:
...
struct DES_Info : public FixedBlockSize<8>, public FixedKeyLength<8>
{
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "DES";}
};
...
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/TripleDES">DES</a>
/// \since Crypto++ 1.0
class DES : public DES_Info, public BlockCipherDocumentation
{
	/// \brief DES block cipher default operation
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<DES_Info>, public RawDES
	{
	public:
...
{
	CryptoPP_NV_2_DLL static const char * CryptoPP_NV_2_API StaticAlgorithmName() {return "DES-EDE2";}
};

/// \brief 2-key TripleDES block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/TripleDES">DES-EDE2</a>
/// \since Crypto++ 1.0
class DES_EDE2 : public DES_EDE2_Info, public BlockCipherDocumentation
{
	/// \brief DES_EDE2 block cipher default operation
	class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<DES_EDE2_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
...
{
	CryptoPP_NV_2_DLL static const char * CryptoPP_NV_2_API StaticAlgorithmName() {return "DES-EDE3";}
};

/// \brief 3-key TripleDES block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/TripleDES">DES-EDE3</a>
/// \since Crypto++ 1.0
class DES_EDE3 : public DES_EDE3_Info, public BlockCipherDocumentation
{
	/// \brief DES_EDE3 block cipher default operation
	class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<DES_EDE3_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "DES-XEX3";}
};

/// \brief DESX block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/TripleDES">DES-XEX3</a>, AKA DESX
/// \since Crypto++ 3.2
class DES_XEX3 : public DES_XEX3_Info, public BlockCipherDocumentation
{
	/// \brief DES_XEX3 block cipher default operation
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<DES_XEX3_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
