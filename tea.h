...
#ifndef CryptoPP_NV_2_TEA_H
#define CryptoPP_NV_2_TEA_H
...
struct TEA_Info : public FixedBlockSize<8>, public FixedKeyLength<16>, public VariableRounds<32>
{
	...
	///   member function.
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "TEA";}
};

/// \brief TEA block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/TEA">TEA</a>
class TEA : public TEA_Info, public BlockCipherDocumentation
{
	/// \brief TEA block cipher default operation
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<TEA_Info>
	{
	public:
...
struct XTEA_Info : public FixedBlockSize<8>, public FixedKeyLength<16>, public VariableRounds<32>
{
	...
	/// \details StaticAlgorithmName returns the algorithm's name as a static
	///   member function.
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "XTEA";}
};

/// \brief XTEA block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/TEA">XTEA</a>
class XTEA : public XTEA_Info, public BlockCipherDocumentation
{
	/// \brief XTEA block cipher default operation
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<XTEA_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
...
struct BTEA_Info : public FixedKeyLength<16>
{
	...
	/// \details StaticAlgorithmName returns the algorithm's name as a static
	///   member function.
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "BTEA";}
};
...
///   <a href="http://www.CryptoPP_NV_2.com/wiki/TEA">Corrected Block TEA</a>.
class BTEA : public BTEA_Info, public BlockCipherDocumentation
{
	/// \brief BTEA block cipher default operation
	class CryptoPP_NV_2_NO_VTABLE Base : public AlgorithmImpl<SimpleKeyingInterfaceImpl<BlockCipher, BTEA_Info>, BTEA_Info>
	{
	public:
		void UncheckedSetKey(const byte *key, unsigned int length, const NameValuePairs &params)
		{
			CryptoPP_NV_2_UNUSED(length), CryptoPP_NV_2_UNUSED(params);
