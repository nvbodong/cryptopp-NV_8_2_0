...
// use "cl /EP /P /DCryptoPP_NV_2_GENERATE_X64_MASM sosemanuk.cpp" to generate MASM code
...
{
#ifndef CryptoPP_NV_2_DISABLE_SOSEMANUK_ASM
...
#if (CryptoPP_NV_2_BOOL_X86 || CryptoPP_NV_2_BOOL_X32 || CryptoPP_NV_2_BOOL_X64) && !defined(CryptoPP_NV_2_DISABLE_SOSEMANUK_ASM)
...
#if CryptoPP_NV_2_SSE2_ASM_AVAILABLE && !defined(CryptoPP_NV_2_DISABLE_SOSEMANUK_ASM)
...
#if defined(__GNUC__) && CryptoPP_NV_2_BOOL_X64
...
#if (CryptoPP_NV_2_BOOL_X86) && !defined(CryptoPP_NV_2_DISABLE_SOSEMANUK_ASM)
		AS_PUSH_IF86(	bp)
...
#define SOSEMANUK_OUTPUT(x)	\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 0, u2 ^ v0);\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 1, u3 ^ v1);\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 2, u1 ^ v2);\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 3, u4 ^ v3);

#define OUTPUT4	\
	S2(0, u0, u1, u2, u3, u4);\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_SWITCH(SOSEMANUK_OUTPUT, 4*4);
