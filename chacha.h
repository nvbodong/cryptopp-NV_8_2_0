...
#ifndef CryptoPP_NV_2_CHACHA_H
#define CryptoPP_NV_2_CHACHA_H
...
/// \since Crypto++ 5.6.4
class CryptoPP_NV_2_NO_VTABLE ChaCha_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
public:
...
protected:
    ...
    CryptoPP_NV_2_CONSTANT(ROUNDS = 20)  // Default rounds
...
/// \since Crypto++ 8.1
class CryptoPP_NV_2_NO_VTABLE ChaChaTLS_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
public:
...
protected:
    ...
    CryptoPP_NV_2_CONSTANT(ROUNDS = ChaChaTLS_Info::ROUNDS)
    CryptoPP_NV_2_CONSTANT(KEY = 16)  // Index into m_state
    CryptoPP_NV_2_CONSTANT(CTR = 24)  // Index into m_state
};
...
///   <A HREF="https://github.com/weidai11/CryptoPP_NV_2/issues/790">Issue
...
/// \since Crypto++ 8.1
class CryptoPP_NV_2_NO_VTABLE XChaCha20_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
public:
