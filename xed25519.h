...
#ifndef CryptoPP_NV_2_XED25519_H
#define CryptoPP_NV_2_XED25519_H
...
{
    CryptoPP_NV_2_CONSTANT(RESERVE_SIZE=2048+64)
    CryptoPP_NV_2_CONSTANT(SIGNATURE_LENGTH=64)
    ...
    ed25519_MessageAccumulator(RandomNumberGenerator &rng) {
        CryptoPP_NV_2_UNUSED(rng); Restart();
    }
...
struct ed25519Signer : public PK_Signer
{
    ...
    size_t MaxRecoverableLengthFromSignatureLength(size_t signatureLength) const {
        CryptoPP_NV_2_UNUSED(signatureLength); return 0;
    }
    ...
    void InputRecoverableMessage(PK_MessageAccumulator &messageAccumulator, const byte *recoverableMessage, size_t recoverableMessageLength) const {
        CryptoPP_NV_2_UNUSED(messageAccumulator); CryptoPP_NV_2_UNUSED(recoverableMessage);
        CryptoPP_NV_2_UNUSED(recoverableMessageLength);
...
struct ed25519Verifier : public PK_Verifier
{
    ...
    void InputSignature(PK_MessageAccumulator &messageAccumulator, const byte *signature, size_t signatureLength) const {
        CryptoPP_NV_2_ASSERT(signature != NULLPTR);
        CryptoPP_NV_2_ASSERT(signatureLength == SIGNATURE_LENGTH);
    ...
    DecodingResult RecoverAndRestart(byte *recoveredMessage, PK_MessageAccumulator &messageAccumulator) const {
        CryptoPP_NV_2_UNUSED(recoveredMessage); CryptoPP_NV_2_UNUSED(messageAccumulator);
...
/// \sa <A HREF="http://CryptoPP_NV_2.com/wiki/Ed25519">Ed25519</A> on the Crypto++ wiki.
/// \since Crypto++ 8.0
struct ed25519
{
...
#endif  // CryptoPP_NV_2_XED25519_H
