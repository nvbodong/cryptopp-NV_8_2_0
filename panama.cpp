...
// use "cl /EP /P /DCryptoPP_NV_2_GENERATE_X64_MASM panama.cpp" to generate MASM code
...
{
#ifndef CryptoPP_NV_2_DISABLE_PANAMA_ASM
# if CryptoPP_NV_2_SSSE3_ASM_AVAILABLE
	if(HasSSSE3())
		return "SSSE3";
# elif CryptoPP_NV_2_SSE2_ASM_AVAILABLE
	if(HasSSE2())
		return "SSE2";
# endif
#endif
...
#if CryptoPP_NV_2_SSSE3_ASM_AVAILABLE && !defined(CryptoPP_NV_2_DISABLE_PANAMA_ASM)
	m_state[17] = HasSSSE3();
#endif
}
...
void Panama_SSE2_Pull(size_t count, word32 *state, word32 *z, const word32 *y);
...
#elif CryptoPP_NV_2_SSE2_ASM_AVAILABLE && !defined(CryptoPP_NV_2_DISABLE_PANAMA_ASM)
	...
	.endprolog
#else
void CryptoPP_NV_2_NOINLINE Panama_SSE2_Pull(size_t count, word32 *state, word32 *z, const word32 *y)
{
...
#define PANAMA_OUTPUT(x)	\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 0, a(0+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 1, a(1+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 2, a(2+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 3, a(3+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 4, a(4+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 5, a(5+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 6, a(6+9));\
	CryptoPP_NV_2_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 7, a(7+9));

			typedef word32 WordType;
			CryptoPP_NV_2_KEYSTREAM_OUTPUT_SWITCH(PANAMA_OUTPUT, 4*8);
		}
...
{
	CryptoPP_NV_2_UNUSED(params); CryptoPP_NV_2_UNUSED(length);
	CryptoPP_NV_2_ASSERT(length==32);
	memcpy(m_key, key, 32);
}
...
{
	CryptoPP_NV_2_UNUSED(keystreamBuffer); CryptoPP_NV_2_UNUSED(iv);
	CryptoPP_NV_2_UNUSED(length); CryptoPP_NV_2_ASSERT(length==32);
...
#if (CryptoPP_NV_2_SSE2_ASM_AVAILABLE || defined(CryptoPP_NV_2_X64_MASM_AVAILABLE)) && !defined(CryptoPP_NV_2_DISABLE_PANAMA_ASM)
