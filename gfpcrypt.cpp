...
{
	CryptoPP_NV_2_UNUSED(rng), CryptoPP_NV_2_UNUSED(recoverableMessage), CryptoPP_NV_2_UNUSED(recoverableMessageLength);
	CryptoPP_NV_2_UNUSED(messageEmpty), CryptoPP_NV_2_UNUSED(hashIdentifier);
	CryptoPP_NV_2_ASSERT(recoverableMessageLength == 0);
	CryptoPP_NV_2_ASSERT(hashIdentifier.second == 0);
	...
	byte *representative, size_t representativeBitLength) const
{
	...
	CryptoPP_NV_2_UNUSED(representative); CryptoPP_NV_2_UNUSED(representativeBitLength);
...
{
	CryptoPP_NV_2_UNUSED(reversible);
...
{
	CryptoPP_NV_2_UNUSED(checkForGroupMembership);
...
void DL_GroupParameters_IntegerBased::AssignFrom(const NameValuePairs &source)
{
	AssignFromHelper(this, source)
		CryptoPP_NV_2_SET_FUNCTION_ENTRY2(Modulus, SubgroupGenerator)
		CryptoPP_NV_2_SET_FUNCTION_ENTRY(SubgroupOrder)
		;
}
