...
#ifndef CryptoPP_NV_2_LUC_H
#define CryptoPP_NV_2_LUC_H
...
public:
	...
	const AbstractGroup<Element> & GetGroup() const {CryptoPP_NV_2_ASSERT(false); throw 0;}
...
public:
	...
	void SetBase(const DL_GroupPrecomputation<Element> &group, const Integer &base)
		{CryptoPP_NV_2_UNUSED(group); m_g = base;}
	const Integer & GetBase(const DL_GroupPrecomputation<Element> &group) const
		{CryptoPP_NV_2_UNUSED(group); return m_g;}
	void Precompute(const DL_GroupPrecomputation<Element> &group, unsigned int maxExpBits, unsigned int storage)
		{CryptoPP_NV_2_UNUSED(group); CryptoPP_NV_2_UNUSED(maxExpBits); CryptoPP_NV_2_UNUSED(storage);}
	void Load(const DL_GroupPrecomputation<Element> &group, BufferedTransformation &storedPrecomputation)
		{CryptoPP_NV_2_UNUSED(group); CryptoPP_NV_2_UNUSED(storedPrecomputation);}
	...
	Integer CascadeExponentiate(const DL_GroupPrecomputation<Element> &group, const Integer &exponent, const DL_FixedBasePrecomputation<Integer> &pc2, const Integer &exponent2) const
		{
			CryptoPP_NV_2_UNUSED(group); CryptoPP_NV_2_UNUSED(exponent); CryptoPP_NV_2_UNUSED(pc2); CryptoPP_NV_2_UNUSED(exponent2);
			// shouldn't be called
...
public:
	...
	{
		CryptoPP_NV_2_UNUSED(element1); CryptoPP_NV_2_UNUSED(exponent1); CryptoPP_NV_2_UNUSED(element2); CryptoPP_NV_2_UNUSED(exponent2);
		throw NotImplemented("LUC_GroupParameters: MultiplyElements can not be implemented");
	}
...
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "LUC-HMP";}
...
struct LUC_IES
	: public DL_ES<
		...
		LUC_IES<> >
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "LUC-IES";}	// non-standard name
};
