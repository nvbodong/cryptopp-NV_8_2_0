...
#ifndef CryptoPP_NV_2_TWOFISH_H
#define CryptoPP_NV_2_TWOFISH_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Twofish";}
};

/// \brief Twofish block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/Twofish">Twofish</a>
/// \since Crypto++ 3.1
class Twofish : public Twofish_Info, public BlockCipherDocumentation
{
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<Twofish_Info>
	{
	public:
