include ksamd64.inc
EXTERNDEF ?Te@rdtable@CryptoPP_NV_2@@3PA_KA:FAR
EXTERNDEF ?g_cacheLineSize@CryptoPP_NV_2@@3IA:FAR
EXTERNDEF ?SHA256_K@CryptoPP_NV_2@@3QBIB:FAR
.CODE
...
.endprolog
mov r8, rcx
mov r11, ?Te@rdtable@CryptoPP_NV_2@@3PA_KA
