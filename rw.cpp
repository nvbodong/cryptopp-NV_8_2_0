...
#if defined(_OPENMP)
# define CryptoPP_NV_2_RW_USE_OMP 1
#else
# define CryptoPP_NV_2_RW_USE_OMP 0
#endif
...
void InvertibleRWFunction::PrecomputeTweakedRoots() const
{
	...
	#pragma omp parallel sections if(CryptoPP_NV_2_RW_USE_OMP)
	{
		#pragma omp section
...
Integer InvertibleRWFunction::CalculateInverse(RandomNumberGenerator &rng, const Integer &x) const
{
	...
	CryptoPP_NV_2_ASSERT((e * f * s.Squared()) % m_n == x);
