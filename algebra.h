...
#ifndef CryptoPP_NV_2_ALGEBRA_H
#define CryptoPP_NV_2_ALGEBRA_H
...
template <class T> class CryptoPP_NV_2_NO_VTABLE AbstractGroup
{
public:
	typedef T Element;
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T> class CryptoPP_NV_2_NO_VTABLE AbstractRing : public AbstractGroup<T>
{
public:
	typedef T Element;
	...
	AbstractRing(const AbstractRing &source)
		{CryptoPP_NV_2_UNUSED(source); m_mg.m_pRing = this;}

	/// \brief Assign an AbstractRing
	/// \param source other AbstractRing
	AbstractRing& operator=(const AbstractRing &source)
		{CryptoPP_NV_2_UNUSED(source); return *this;}
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T> class CryptoPP_NV_2_NO_VTABLE AbstractEuclideanDomain : public AbstractRing<T>
{
public:
	typedef T Element;
...
public:
	...
	bool operator==(const EuclideanDomainOf<T> &rhs) const
		{CryptoPP_NV_2_UNUSED(rhs); return true;}
