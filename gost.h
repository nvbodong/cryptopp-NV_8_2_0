...
#ifndef CryptoPP_NV_2_GOST_H
#define CryptoPP_NV_2_GOST_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "GOST";}
};

/// \brief GOST block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/GOST">GOST</a>
/// \since Crypto++ 2.1
class GOST : public GOST_Info, public BlockCipherDocumentation
{
	/// \brief GOST block cipher default operation
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<GOST_Info>
	{
	public:
