...
#ifndef CryptoPP_NV_2_VMAC_H
#define CryptoPP_NV_2_VMAC_H
...
# define CryptoPP_NV_2_DISABLE_VMAC_ASM 1
#endif
...
protected:
	...
	CryptoPP_NV_2_BLOCK_1(polyState, word64, 4*(m_is128+1))
	CryptoPP_NV_2_BLOCK_2(nhKey, word64, m_L1KeyLength/sizeof(word64) + 2*m_is128)
	CryptoPP_NV_2_BLOCK_3(data, byte, m_L1KeyLength)
	CryptoPP_NV_2_BLOCK_4(l3Key, word64, 2*(m_is128+1))
	CryptoPP_NV_2_BLOCK_5(nonce, byte, IVSize())
	CryptoPP_NV_2_BLOCK_6(pad, byte, IVSize())
	CryptoPP_NV_2_BLOCKS_END(6)
