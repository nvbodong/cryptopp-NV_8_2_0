...
using CryptoPP_NV_2::VecOr;
using CryptoPP_NV_2::VecXor;
using CryptoPP_NV_2::VecAnd;

using CryptoPP_NV_2::VecPermute;
using CryptoPP_NV_2::VecMergeLow;
using CryptoPP_NV_2::VecMergeHigh;
using CryptoPP_NV_2::VecShiftLeft;
using CryptoPP_NV_2::VecShiftRight;

using CryptoPP_NV_2::VecPolyMultiply00LE;
using CryptoPP_NV_2::VecPolyMultiply11LE;
