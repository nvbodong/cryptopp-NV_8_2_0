...
#ifndef CryptoPP_NV_2_SHA_H
#define CryptoPP_NV_2_SHA_H
...
# define CryptoPP_NV_2_DISABLE_SHA_ASM 1
#endif
...
class CryptoPP_NV_2_DLL SHA1 : public IteratedHashWithStaticTransform<word32, BigEndian, 64, 20, SHA1>
{
public:
	...
	static void CryptoPP_NV_2_API InitState(HashWordType *state);
	...
	static void CryptoPP_NV_2_API Transform(HashWordType *digest, const HashWordType *data);
	/// \brief The algorithm name
	/// \returns C-style string "SHA-1"
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "SHA-1";}
	// Algorithm class
...
class CryptoPP_NV_2_DLL SHA256 : public IteratedHashWithStaticTransform<word32, BigEndian, 64, 32, SHA256, 32, true>
{
public:
	/// \brief Initialize state array
	/// \param state the state of the hash
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "SHA-256";}
...
/// \since SHA2 since Crypto++ 4.0, ARMv8 SHA since Crypto++ 6.0,
///   Intel SHA since Crypto++ 6.0, Power8 SHA since Crypto++ 6.1
class CryptoPP_NV_2_DLL SHA224 : public IteratedHashWithStaticTransform<word32, BigEndian, 64, 32, SHA224, 28, true>
{
public:
	/// \brief Initialize state array
	/// \param state the state of the hash
	...
	///   with the user supplied state.
	/// \note On Intel platforms the state array and data must be 16-byte aligned for SSE2.
	static void CryptoPP_NV_2_API Transform(HashWordType *digest, const HashWordType *data) {SHA256::Transform(digest, data);}
	/// \brief The algorithm name
	/// \returns C-style string "SHA-224"
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "SHA-224";}
...
class CryptoPP_NV_2_DLL SHA512 : public IteratedHashWithStaticTransform<word64, BigEndian, 128, 64, SHA512, 64, true>
{
public:
	/// \brief Initialize state array
	/// \param state the state of the hash
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "SHA-512";}
...
/// \since SHA2 since Crypto++ 4.0, Power8 SHA since Crypto++ 6.1
class CryptoPP_NV_2_DLL SHA384 : public IteratedHashWithStaticTransform<word64, BigEndian, 128, 64, SHA384, 48, true>
{
public:
	/// \brief Initialize state array
	/// \param state the state of the hash
	...
	///   with the user supplied state.
	/// \note On Intel platforms the state array and data must be 16-byte aligned for SSE2.
	static void CryptoPP_NV_2_API Transform(HashWordType *digest, const HashWordType *data) {SHA512::Transform(digest, data);}
	/// \brief The algorithm name
	/// \returns C-style string "SHA-384"
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "SHA-384";}
