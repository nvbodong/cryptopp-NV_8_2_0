...
#ifndef CryptoPP_NV_2_OAEP_H
#define CryptoPP_NV_2_OAEP_H
...
/// \since Crypto++ 2.1
class CryptoPP_NV_2_DLL OAEP_Base : public PK_EncryptionMessageEncodingMethod
{
public:
...
{
public:
	static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return std::string("OAEP-") + MGF::StaticAlgorithmName() + "(" + H::StaticAlgorithmName() + ")";}
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS OAEP<SHA1>;
