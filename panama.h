...
#ifndef CryptoPP_NV_2_PANAMA_H
#define CryptoPP_NV_2_PANAMA_H
...
//# define CryptoPP_NV_2_DISABLE_PANAMA_ASM
//#endif

// https://github.com/weidai11/CryptoPP_NV_2/issues/758
#define CryptoPP_NV_2_DISABLE_PANAMA_ASM 1

NAMESPACE_BEGIN(CryptoPP_NV_2)

// Base class, do not use directly
template <class B>
class CryptoPP_NV_2_NO_VTABLE Panama
{
public:
	virtual ~Panama() {}
...
protected:
	...
	CryptoPP_NV_2_CONSTANT(STAGES = 32)
...
public:
	...
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == BIG_ENDIAN_ORDER ? "Panama-BE" : "Panama-LE";}
	std::string AlgorithmProvider() const {return Panama<B>::AlgorithmProvider();} // Fix https://github.com/weidai11/CryptoPP_NV_2/issues/801
