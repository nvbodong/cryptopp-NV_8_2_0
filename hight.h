...
#ifndef CryptoPP_NV_2_HIGHT_H
#define CryptoPP_NV_2_HIGHT_H
...
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/HIGHT">HIGHT</a>,
///   <a href="https://seed.kisa.or.kr/">Korea Internet &amp; Security
///   Agency</a> website
/// \since Crypto++ 8.0
class CryptoPP_NV_2_NO_VTABLE HIGHT : public HIGHT_Info, public BlockCipherDocumentation
{
public:
    /// \brief HIGHT block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<HIGHT_Info>
    {
    protected:
