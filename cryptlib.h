...
<p>Click <a href="CryptoPP_NV_2Ref.zip">here</a> to download a zip archive containing this manual.
<p>Thanks to Ryan Phillips for providing the Doxygen configuration file
and getting us started on the manual.
*/

#ifndef CryptoPP_NV_2_CRYPTLIB_H
#define CryptoPP_NV_2_CRYPTLIB_H
...
class CryptoPP_NV_2_DLL Exception : public std::exception
{
public:
	/// \enum ErrorType
...
/// \brief An invalid argument was detected
class CryptoPP_NV_2_DLL InvalidArgument : public Exception
{
public:
...
/// \brief Input data was received that did not conform to expected format
class CryptoPP_NV_2_DLL InvalidDataFormat : public Exception
{
public:
...
class CryptoPP_NV_2_DLL InvalidCiphertext : public InvalidDataFormat
{
public:
...
/// \brief A method was called which was not implemented
class CryptoPP_NV_2_DLL NotImplemented : public Exception
{
public:
...
class CryptoPP_NV_2_DLL CannotFlush : public Exception
{
public:
...
class CryptoPP_NV_2_DLL OS_Error : public Exception
{
public:
...
struct CryptoPP_NV_2_DLL DecodingResult
{
...
///   <A HREF="http://www.CryptoPP_NV_2.com/wiki/NameValuePairs">NameValuePairs</A> on the Crypto++ wiki
...
public:
	...
	class CryptoPP_NV_2_DLL ValueTypeMismatch : public InvalidArgument
	{
	public:
	...
	CryptoPP_NV_2_DLL std::string GetValueNames() const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CryptoPP_NV_2_DLL bool GetIntValue(const char *name, int &value) const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CryptoPP_NV_2_DLL int GetIntValueWithDefault(const char *name, int defaultValue) const
	...
	CryptoPP_NV_2_DLL bool GetWord64Value(const char *name, word64 &value) const
		{return GetValue(name, value);}
	...
	CryptoPP_NV_2_DLL word64 GetWord64ValueWithDefault(const char *name, word64 defaultValue) const
		{return GetValueWithDefault(name, defaultValue);}
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CryptoPP_NV_2_DLL static void CryptoPP_NV_2_API ThrowIfTypeMismatch(const char *name, const std::type_info &stored, const std::type_info &retrieving)
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CryptoPP_NV_2_DLL void GetRequiredIntParameter(const char *className, const char *name, int &value) const
	{
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CryptoPP_NV_2_DLL virtual bool GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const =0;
};
...
#else
extern CryptoPP_NV_2_DLL const std::string DEFAULT_CHANNEL;
extern CryptoPP_NV_2_DLL const std::string AAD_CHANNEL;
extern CryptoPP_NV_2_DLL const NameValuePairs& g_nullNameValuePairs;
#endif

// Document additional name spaces which show up elsewhere in the sources.
#if CryptoPP_NV_2_DOXYGEN_PROCESSING
/// \brief Namespace containing value name definitions.
/// \details Name is part of the CryptoPP_NV_2 namespace.
...
/// \details Weak is part of the CryptoPP_NV_2 namespace. Schemes and algorithms are moved into Weak
...
///   CryptoPP_NV_2_ENABLE_NAMESPACE_WEAK 1</tt> before including a header for a weak or wounded
///   algorithm. For example:
///   <pre>
///     \c \#define CryptoPP_NV_2_ENABLE_NAMESPACE_WEAK 1
///     \c \#include <md5.h>
///     ...
///     CryptoPP_NV_2::Weak::MD5 md5;
///   </pre>
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Clonable
{
public:
	virtual ~Clonable() {}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE Algorithm : public Clonable
{
public:
	virtual ~Algorithm() {}
	...
	///    CryptoPP_NV_2_ENABLE_COMPLIANCE_WITH_FIPS_140_2 in config.h.
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE SimpleKeyingInterface
{
public:
	...
	virtual void Resynchronize(const byte *iv, int ivLength=-1) {
		CryptoPP_NV_2_UNUSED(iv); CryptoPP_NV_2_UNUSED(ivLength);
		throw NotImplemented(GetAlgorithm().AlgorithmName() + ": this object doesn't support resynchronization");
	}
...
protected:
	...
	inline void AssertValidKeyLength(size_t length) const
		{CryptoPP_NV_2_UNUSED(length); CryptoPP_NV_2_ASSERT(IsValidKeyLength(length));}
};
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE BlockTransformation : public Algorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE StreamTransformation : public Algorithm
{
public:
	...
	///   \ref CryptoPP_NV_2_ASSERT "asserts" IsRandomAccess() in debug builds.
	virtual void Seek(lword pos)
	{
		CryptoPP_NV_2_UNUSED(pos);
		CryptoPP_NV_2_ASSERT(!IsRandomAccess());
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE HashTransformation : public Algorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE BlockCipher : public SimpleKeyingInterface, public BlockTransformation
{
protected:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE SymmetricCipher : public SimpleKeyingInterface, public StreamTransformation
{
protected:
	const Algorithm & GetAlgorithm() const {return *this;}
};
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE MessageAuthenticationCode : public SimpleKeyingInterface, public HashTransformation
{
protected:
	const Algorithm & GetAlgorithm() const {return *this;}
};
...
/// \sa <A HREF="http://www.CryptoPP_NV_2.com/wiki/Authenticated_Encryption">Authenticated
///   Encryption</A> on the Crypto++ wiki.
/// \since Crypto++ 5.6.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE AuthenticatedSymmetricCipher : public MessageAuthenticationCode, public StreamTransformation
{
public:
...
protected:
	...
	virtual void UncheckedSpecifyDataLengths(lword headerLength, lword messageLength, lword footerLength)
		{CryptoPP_NV_2_UNUSED(headerLength); CryptoPP_NV_2_UNUSED(messageLength); CryptoPP_NV_2_UNUSED(footerLength);}
};
...
/// \since Crypto++ 3.1
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE RandomNumberGenerator : public Algorithm
{
public:
...
/// \since Crypto++ 7.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE KeyDerivationFunction : public Algorithm
{
public:
...
CryptoPP_NV_2_DLL RandomNumberGenerator & CryptoPP_NV_2_API NullRNG();

class WaitObjectContainer;
class CallStack;

/// \brief Interface for objects that can be waited on.
class CryptoPP_NV_2_NO_VTABLE Waitable
{
public:
	virtual ~Waitable() {}
...
/// \nosubgrouping
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE BufferedTransformation : public Algorithm, public Waitable
{
public:
	...
	//@{
		...
		virtual void IsolatedInitialize(const NameValuePairs &parameters) {
			CryptoPP_NV_2_UNUSED(parameters);
		...
		virtual bool IsolatedMessageSeriesEnd(bool blocking)
			{CryptoPP_NV_2_UNUSED(blocking); return false;}
		...
		virtual void SetAutoSignalPropagation(int propagation)
			{CryptoPP_NV_2_UNUSED(propagation);}
...
public:
	...
	//@{
		...
		virtual BufferedTransformation *AttachedTransformation() {CryptoPP_NV_2_ASSERT(!Attachable()); return NULLPTR;}
		...
		virtual void Detach(BufferedTransformation *newAttachment = NULLPTR) {
			CryptoPP_NV_2_UNUSED(newAttachment); CryptoPP_NV_2_ASSERT(!Attachable());
...
CryptoPP_NV_2_DLL BufferedTransformation & TheBitBucket();

/// \brief Interface for crypto material, such as public and private keys, and crypto parameters
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CryptoMaterial : public NameValuePairs
{
public:
	/// Exception thrown when invalid crypto material is detected
	class CryptoPP_NV_2_DLL InvalidMaterial : public InvalidDataFormat
	{
	public:
	...
	virtual void Save(BufferedTransformation &bt) const
		{CryptoPP_NV_2_UNUSED(bt); throw NotImplemented("CryptoMaterial: this object does not support saving");}
	...
	virtual void Load(BufferedTransformation &bt)
		{CryptoPP_NV_2_UNUSED(bt); throw NotImplemented("CryptoMaterial: this object does not support loading");}
	...
	virtual void Precompute(unsigned int precomputationStorage) {
		CryptoPP_NV_2_UNUSED(precomputationStorage); CryptoPP_NV_2_ASSERT(!SupportsPrecomputation());
	...
	virtual void LoadPrecomputation(BufferedTransformation &storedPrecomputation)
		{CryptoPP_NV_2_UNUSED(storedPrecomputation); CryptoPP_NV_2_ASSERT(!SupportsPrecomputation()); throw NotImplemented("CryptoMaterial: this object does not support precomputation");}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE GeneratableCryptoMaterial : virtual public CryptoMaterial
{
public:
	...
	virtual void GenerateRandom(RandomNumberGenerator &rng, const NameValuePairs &params = g_nullNameValuePairs) {
		CryptoPP_NV_2_UNUSED(rng); CryptoPP_NV_2_UNUSED(params);
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PublicKey : virtual public CryptoMaterial
{
};

/// \brief Interface for private keys
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PrivateKey : public GeneratableCryptoMaterial
{
};

/// \brief Interface for crypto prameters
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CryptoParameters : public GeneratableCryptoMaterial
{
};
...
/// \sa <A HREF="https://github.com/weidai11/CryptoPP_NV_2/issues/569">Issue 569</A>
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE AsymmetricAlgorithm : public Algorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PublicKeyAlgorithm : public AsymmetricAlgorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PrivateKeyAlgorithm : public AsymmetricAlgorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE KeyAgreementAlgorithm : public AsymmetricAlgorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_CryptoSystem
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_Encryptor : public PK_CryptoSystem, public PublicKeyAlgorithm
{
public:
	/// \brief Exception thrown when trying to encrypt plaintext of invalid length
	class CryptoPP_NV_2_DLL InvalidPlaintextLength : public Exception
	{
	public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_Decryptor : public PK_CryptoSystem, public PrivateKeyAlgorithm
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_SignatureScheme
{
public:
	...
	class CryptoPP_NV_2_DLL InvalidKeyLength : public Exception
	{
	public:
	...
	class CryptoPP_NV_2_DLL KeyTooShort : public InvalidKeyLength
	{
	public:
	...
	{CryptoPP_NV_2_UNUSED(recoverablePartLength); return SignatureLength();}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_MessageAccumulator : public HashTransformation
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_Signer : public PK_SignatureScheme, public PrivateKeyAlgorithm
{
public:
	virtual ~PK_Signer() {}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE PK_Verifier : public PK_SignatureScheme, public PublicKeyAlgorithm
{
public:
	virtual ~PK_Verifier() {}
...
/// \since Crypto++ 3.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE SimpleKeyAgreementDomain : public KeyAgreementAlgorithm
{
public:
...
/// \since Crypto++ 3.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE AuthenticatedKeyAgreementDomain : public KeyAgreementAlgorithm
{
public:
...
class CryptoPP_NV_2_DLL BERDecodeErr : public InvalidArgument
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE ASN1Object
{
public:
	virtual ~ASN1Object() {}
...
///   CryptoPP_NV_2 namespace to help programs locate the symbol. If the symbol is present, then
...
///      }
/// </pre>
/// \sa HeaderVersion(), <A HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/371">GitHub Issue 371</A>.
/// \since Crypto++ 6.0
extern "C" {
	int LibraryVersion(CryptoPP_NV_2_NOINLINE_DOTDOTDOT);
} // C linkage
...
///      }
/// </pre>
/// \sa LibraryVersion(), <A HREF="http://github.com/weidai11/CryptoPP_NV_2/issues/371">GitHub Issue 371</A>.
/// \since Crypto++ 6.0
extern "C" {
inline int HeaderVersion()
{
	return CryptoPP_NV_2_VERSION;
}
} // C linkage
