...
#ifndef CryptoPP_NV_2_ALGPARAM_H
#define CryptoPP_NV_2_ALGPARAM_H
...
public:
	...
	template <class T> ConstByteArrayParameter(const T &string, bool deepCopy = false)
		: m_deepCopy(false), m_data(NULLPTR), m_size(0)
	{
		CryptoPP_NV_2_COMPILE_ASSERT(sizeof(typename T::value_type) == 1);
	...
	void Assign(const byte *data, size_t size, bool deepCopy)
	{
		...
		// CryptoPP_NV_2_ASSERT((data && size) || !(data || size));
		if (deepCopy)
...
class CryptoPP_NV_2_DLL CombinedNameValuePairs : public NameValuePairs
{
public:
...
CryptoPP_NV_2_DLL bool AssignIntToInteger(const std::type_info &valueType, void *pInteger, const void *pInt);
#endif

CryptoPP_NV_2_DLL const std::type_info & CryptoPP_NV_2_API IntegerTypeId();

/// \brief Base class for AlgorithmParameters
class CryptoPP_NV_2_DLL AlgorithmParametersBase
{
public:
	...
	virtual ~AlgorithmParametersBase() CryptoPP_NV_2_THROW
	{

#if defined(CryptoPP_NV_2_CXX17_EXCEPTIONS)
		if (std::uncaught_exceptions() == 0)
#elif defined(CryptoPP_NV_2_UNCAUGHT_EXCEPTION_AVAILABLE)
...
#if !defined(CryptoPP_NV_2_CXX17_EXCEPTIONS) && !defined(CryptoPP_NV_2_UNCAUGHT_EXCEPTION_AVAILABLE)
...
# undef new
	...
	void MoveInto(void *buffer) const
	{
		...
		CryptoPP_NV_2_UNUSED(p);	// silence warning
	}
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AlgorithmParametersTemplate<bool>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AlgorithmParametersTemplate<int>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AlgorithmParametersTemplate<ConstByteArrayParameter>;
...
///   </pre>
class CryptoPP_NV_2_DLL AlgorithmParameters : public NameValuePairs
{
public:
...
#define CryptoPP_NV_2_GET_FUNCTION_ENTRY(name)		(Name::name(), &ThisClass::Get##name)
#define CryptoPP_NV_2_SET_FUNCTION_ENTRY(name)		(Name::name(), &ThisClass::Set##name)
#define CryptoPP_NV_2_SET_FUNCTION_ENTRY2(name1, name2)	(Name::name1(), Name::name2(), &ThisClass::Set##name1##And##name2)
