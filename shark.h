...
#ifndef CryptoPP_NV_2_SHARK_H
#define CryptoPP_NV_2_SHARK_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SHARK-E";}
};

/// \brief SHARK block cipher
/// <a href="http://www.CryptoPP_NV_2.com/wiki/SHARK-E">SHARK-E</a>
/// \since Crypto++ 2.1
class SHARK : public SHARK_Info, public BlockCipherDocumentation
{
	/// \brief SHARK block cipher default operation
	/// \since Crypto++ 2.1
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SHARK_Info>
	{
	public:
