...
#ifndef CryptoPP_NV_2_CBCMAC_H
#define CryptoPP_NV_2_CBCMAC_H
...
/// \since Crypto++ 3.1
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CBC_MAC_Base : public MessageAuthenticationCode
{
public:
