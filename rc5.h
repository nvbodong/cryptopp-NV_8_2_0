...
#ifndef CryptoPP_NV_2_RC5_H
#define CryptoPP_NV_2_RC5_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RC5";}
	typedef word32 RC5_WORD;
};

/// \brief RC5 block cipher
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/RC5">RC5</a>
/// \since Crypto++ 1.0
class RC5 : public RC5_Info, public BlockCipherDocumentation
{
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<RC5_Info>
	{
	public:
