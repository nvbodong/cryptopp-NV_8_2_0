...
#ifndef CryptoPP_NV_2_MODES_H
#define CryptoPP_NV_2_MODES_H
...
/// \brief Block cipher mode of operation information
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CipherModeBase : public SymmetricCipher
{
public:
...
protected:
	...
	{
		CryptoPP_NV_2_ASSERT(m_register.size() > 0);
...
class CryptoPP_NV_2_NO_VTABLE ModePolicyCommonTemplate : public CipherModeBase, public POLICY_INTERFACE
{
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CFB_ModePolicy : public ModePolicyCommonTemplate<CFB_CipherAbstractPolicy>
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "CFB";}
...
{
	CryptoPP_NV_2_ASSERT(dest);
	CryptoPP_NV_2_ASSERT(dsize >= ssize);
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE OFB_ModePolicy : public ModePolicyCommonTemplate<AdditiveCipherAbstractPolicy>
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "OFB";}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CTR_ModePolicy : public ModePolicyCommonTemplate<AdditiveCipherAbstractPolicy>
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "CTR";}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE BlockOrientedCipherModeBase : public CipherModeBase
{
public:
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE ECB_OneWay : public BlockOrientedCipherModeBase
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "ECB";}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CBC_ModeBase : public BlockOrientedCipherModeBase
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "CBC";}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CBC_Encryption : public CBC_ModeBase
{
public:
	void ProcessData(byte *outString, const byte *inString, size_t length);
};
...
/// \since Crypto++ 3.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CBC_CTS_Encryption : public CBC_Encryption
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* CryptoPP_NV_2_API StaticAlgorithmName() {return "CBC/CTS";}
...
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CBC_Decryption : public CBC_ModeBase
{
public:
...
/// \since Crypto++ 3.0
class CryptoPP_NV_2_DLL CryptoPP_NV_2_NO_VTABLE CBC_CTS_Decryption : public CBC_Decryption
{
public:
	unsigned int MinLastBlockSize() const {return BlockSize()+1;}
	size_t ProcessLastBlock(byte *outString, size_t outLength, const byte *inString, size_t inLength);
...
public:
	...
	///   Shoup's ECIES.
	static std::string CryptoPP_NV_2_API StaticAlgorithmName()
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CFB_CipherTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, CFB_ModePolicy> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CFB_EncryptionTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, CFB_ModePolicy> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CFB_DecryptionTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, CFB_ModePolicy> >;

/// \brief CFB block cipher mode of operation
/// \sa <A HREF="http://www.CryptoPP_NV_2.com/wiki/Modes_of_Operation">Modes of Operation</A>
///   on the Crypto++ wiki.
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, OFB_ModePolicy> >;
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, CTR_ModePolicy> >;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<ConcretePolicyHolder<Empty, AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, CTR_ModePolicy> > > >;
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<ECB_OneWay>;
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_Encryption>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_Decryption>;
...
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_CTS_Encryption>;
CryptoPP_NV_2_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_CTS_Decryption>;
