...
#ifndef CryptoPP_NV_2_HEX_H
#define CryptoPP_NV_2_HEX_H
...
class CryptoPP_NV_2_DLL HexEncoder : public SimpleProxyFilter
{
public:
...
class CryptoPP_NV_2_DLL HexDecoder : public BaseN_Decoder
{
public:
...
private:
	static const int * CryptoPP_NV_2_API GetDefaultDecodingLookupArray();
};
