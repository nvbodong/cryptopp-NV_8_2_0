...
#ifndef CryptoPP_NV_2_SHACAL2_H
#define CryptoPP_NV_2_SHACAL2_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SHACAL-2";}
};

/// \brief SHACAL2 block cipher
/// \since Crypto++ 5.2, Intel SHA since Crypto++ 6.0
/// \sa <a href="http://www.CryptoPP_NV_2.com/wiki/SHACAL-2">SHACAL-2</a>
class SHACAL2 : public SHACAL2_Info, public BlockCipherDocumentation
{
	...
	class CryptoPP_NV_2_NO_VTABLE Base : public BlockCipherImpl<SHACAL2_Info>
	{
	public:
