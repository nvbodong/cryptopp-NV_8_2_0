...
#ifndef CryptoPP_NV_2_PSSR_H
#define CryptoPP_NV_2_PSSR_H
...
/// \since Crypto++ 2.1
class CryptoPP_NV_2_DLL PSSR_MEM_Base : public PK_RecoverableSignatureMessageEncodingMethod
{
public:
...
public:
	static std::string CryptoPP_NV_2_API StaticAlgorithmName() {return std::string(ALLOW_RECOVERY ? "PSSR-" : "PSS-") + MGF::StaticAlgorithmName();}
};
