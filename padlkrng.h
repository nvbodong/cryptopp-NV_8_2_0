...
/// \since Crypto++ 6.0
/// \sa <A HREF="http://www.CryptoPP_NV_2.com/wiki/VIA_Padlock">VIA
///   Padlock</A> on the Crypto++ wiki

#ifndef CryptoPP_NV_2_PADLOCK_RNG_H
#define CryptoPP_NV_2_PADLOCK_RNG_H
...
///   at <A HREF="http://www.CryptoPP_NV_2.com/wiki/VIA_Padlock">VIA Padlock</A>.
/// \sa MaurerRandomnessTest() for random bit generators
/// \since Crypto++ 6.0
class PadlockRNG : public RandomNumberGenerator
{
public:
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "PadlockRNG"; }
...
#endif  // CryptoPP_NV_2_PADLOCK_RNG_H
