...
#ifndef CryptoPP_NV_2_OS_SIGNAL_H
#define CryptoPP_NV_2_OS_SIGNAL_H
...
#if defined(UNIX_SIGNALS_AVAILABLE) || defined(CryptoPP_NV_2_DOXYGEN_PROCESSING)
...
extern "C" {
    inline void NullSignalHandler(int unused) {CryptoPP_NV_2_UNUSED(unused);}
}
...
/// \since Crypto++ 5.6.5
/// \sa NullSignalHandler, SignalHandlerFn, \ref CryptoPP_NV_2_ASSERT "CryptoPP_NV_2_ASSERT", DebugTrapHandler
...
#endif // CryptoPP_NV_2_OS_SIGNAL_H
