...
#ifndef CryptoPP_NV_2_WAKE_H
#define CryptoPP_NV_2_WAKE_H
...
{
	CryptoPP_NV_2_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == LITTLE_ENDIAN_ORDER ? "WAKE-OFB-LE" : "WAKE-OFB-BE";}
};

class CryptoPP_NV_2_NO_VTABLE WAKE_Base
{
protected:
...
/// \since Crypto++ 1.0
template <class B = BigEndian>
class CryptoPP_NV_2_NO_VTABLE WAKE_Policy : public AdditiveCipherConcretePolicy<word32, 1, 64>, protected WAKE_Base
{
protected:
